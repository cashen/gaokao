...
export const RESOURCE_EXECUTION_VERSION = 'resource-execution-v3990_1';
...
export const RESOURCE_EXECUTION_REGISTRY = Object.freeze({
  ...
  release: entry({
    ...
    generatedArtifacts: ['/ln-rank/site-active-generation.v3990_1.json'],
    validationTools: [
  ...
  siteRuntime: entry({
    ...
    generatedArtifacts: ['/ln-rank/site-active-generation.v3990_1.json'],
    validationTools: ['/tools/audit-site-runtime-generation-v3990_1.mjs']
  }),
  interaction: entry({
    ...
    schemaVersion: 'interaction-transaction-v3990_1',
    activationContractVersion: 'native-chooser-activation-integrity-v3990_1',
  ...
  home: entry({
    ...
    schemaVersion: 'family-home-runtime-v3990_1',
    classification: 'current-generation',
    validationTools: ['/tools/audit-site-runtime-generation-v3990_1.mjs', '/tools/browser-home-release-v3990_1.mjs']
  }),
  uiComponents: entry({
    ...
    schemaVersion: 'ui-component-execution-v3990_1',
    ...
    validationTools: ['/tools/audit-site-runtime-generation-v3990_1.mjs', '/tools/browser-family-action-v3990_1.mjs']
  }),
  majorBands: entry({
    owner: '/functions/api/major-bands.js',
    dataOwner: '/ln-rank/data/major-bands-static-v3972_2/manifest.json',
    rankIndexOwner: '/functions/_lib/major-bands-rank-index.v3990_1.js',
    queryKernelOwner: '/functions/_lib/major-bands-rank-query-kernel.v3990_1.js',
    bucketLoaderOwner: '/functions/_lib/major-bands-rank-bucket-loader.v3990_1.js',
    bucketCacheOwner: '/functions/api/major-bands.js',
    resultOrderOwner: '/functions/_lib/major-bands-result-order.v3990_1.js',
    responseTransportOwner: '/functions/_lib/major-bands-response-transport.v3990_1.js',
    ...
    schemaVersion: 'major-bands-single-worker-rank-window-v3990_1',
    ...
    generatedArtifacts: ['/functions/_lib/major-bands-rank-index.v3990_1.js'],
    validationTools: [
      '/tools/build-major-bands-rank-index-v3990_1.mjs',
  ...
  familyAction: entry({
    ...
    schemaVersion: 'family-action-v3990_1',
    classification: 'current-generation',
    validationTools: ['/tools/audit-site-runtime-generation-v3990_1.mjs', '/tools/browser-family-action-v3990_1.mjs']
  })
});
