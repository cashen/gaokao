...
export const PRODUCTION_RESOURCE_VERIFICATION_CONTRACT = Object.freeze({
  ...
  requiredStaticResources: Object.freeze({
    ...
    siteRuntimeContract: '/shared/resources/release/site-runtime-contract.v3990_1.js',
    runtimeCache: '/shared/resources/release/runtime-cache-contract.v3990_1.js',
    resourceRegistry: '/shared/resources/resource-registry.js',
    uiRegistry: '/shared/ui/ui-resource-registry.v3990_1.js',
    executionContract: '/shared/governance/resource-execution-contract.v3990_1.js',
    productionContract: '/shared/governance/production-resource-verification-contract.v3990_1.js',
    activeManifest: '/ln-rank/site-active-generation.v3990_1.json',
    selectionPage: '/ln-rank/',
    interactionRuntime: '/shared/ui/interaction/interaction-transaction.v3990_1.js',
    interactionStyles: '/shared/ui/interaction/interaction-transaction.v3990_1.css',
    selectionBootstrap: '/ln-rank/js/app.v3990_1.js',
    selectionRuntime: '/ln-rank/js/app-runtime.v3990_1.js',
    selectionWorkspace: '/ln-rank/js/workspace/selection-workspace-orchestrator.v3990_1.js',
    majorBandsPaginationSnapshotGuard: '/ln-rank/js/feature/major-pool/pagination-snapshot-guard.v3990_1.js',
    selfCheck: '/ln-rank/self-check.html',
    selfCheckRuntime: '/ln-rank/js/self-check.v3990_1.js'
  }),
