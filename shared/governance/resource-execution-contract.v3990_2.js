...
export const RESOURCE_EXECUTION_REGISTRY = Object.freeze({
  ...
  siteRuntime: entry({
    ...
    validationTools: ['/tools/audit-site-runtime-generation-v3990_2.mjs']
  }),
  interaction: entry({
    ...
    schemaVersion: 'interaction-transaction-v3990_2',
    activationContractVersion: 'native-chooser-activation-integrity-v3990_2',
  ...
  uiComponents: entry({
    ...
    schemaVersion: 'ui-component-execution-v3990_2',
  ...
  majorBands: entry({
    ...
    rankIndexOwner: '/functions/_lib/major-bands-rank-index.v3990_2.js',
    queryKernelOwner: '/functions/_lib/major-bands-rank-query-kernel.v3990_2.js',
    bucketLoaderOwner: '/functions/_lib/major-bands-rank-bucket-loader.v3990_2.js',
    bucketCacheOwner: '/functions/api/major-bands.js',
    resultOrderOwner: '/functions/_lib/major-bands-result-order.v3990_2.js',
    responseTransportOwner: '/functions/_lib/major-bands-response-transport.v3990_2.js',
    ...
    schemaVersion: 'major-bands-single-worker-rank-window-v3990_2',
    ...
    generatedArtifacts: ['/functions/_lib/major-bands-rank-index.v3990_2.js'],
    validationTools: [
