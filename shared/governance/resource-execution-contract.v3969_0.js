export const RESOURCE_EXECUTION_VERSION = 'resource-execution-v3969_0';
...
export const RESOURCE_EXECUTION_REGISTRY = Object.freeze({
  release: entry({
    ...
    schemaVersion: 'current-release-v3969_0',
    ...
    validationTools: ['/tools/ln-2026/verify-final-release-v10.py','/tools/audit-school-query-v3969.mjs','/tools/audit-academic-background-v3968.mjs']
  }),
  exam: entry({
  ...
  rankTables: entry({
    ...
    validationTools: ['/tools/audit-three-year-rank-evidence-v3968.mjs','/tools/audit-school-query-v3969.mjs']
  }),
  schoolQuery: entry({
    ...
    validationTools: ['/tools/audit-school-query-v3969.mjs','/tools/browser-school-query-v3969.mjs']
  }),
  ...
  uiComponents: entry({
    ...
    validationTools: ['/tools/audit-css-component-isolation-v3967.mjs','/tools/browser-resource-execution-v3968.mjs','/tools/browser-school-query-v3969.mjs']
  }),
  ...
  reports: entry({
    ...
    validationTools: ['/tools/audit-report-execution-v3967.mjs','/tools/browser-school-query-v3969.mjs']
  })
});
