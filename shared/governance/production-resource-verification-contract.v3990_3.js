...
export const PRODUCTION_RESOURCE_VERIFICATION_CONTRACT = Object.freeze({
  version: 'production-resource-graph-verification-v3990_3',
  ...
  requiredStaticResources: Object.freeze({
    ...
    uiRegistry: '/shared/ui/ui-resource-registry.v3990_3.js',
    executionContract: '/shared/governance/resource-execution-contract.v3990_3.js',
    productionContract: '/shared/governance/production-resource-verification-contract.v3990_3.js',
    activeManifest: '/ln-rank/site-active-generation.v3990_3.json',
    ...
    selectionBootstrap: '/ln-rank/js/app.v3990_3.js',
    selectionRuntime: '/ln-rank/js/app-runtime.v3990_3.js',
    selectionWorkspace: '/ln-rank/js/workspace/selection-workspace-orchestrator.v3990_3.js',
    majorBandsPaginationSnapshotGuard: '/ln-rank/js/feature/major-pool/pagination-snapshot-guard.v3990_3.js',
    selfCheck: '/ln-rank/self-check.html',
    selfCheckRuntime: '/ln-rank/js/self-check.v3990_3.js'
  }),
