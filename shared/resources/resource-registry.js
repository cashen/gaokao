import { CURRENT_RELEASE } from './release/current-release.js?v=3990_2&r=r034-worker-1102-bounded-api';
import { ACTIVE_RESOURCE_MANIFEST } from './release/active-resource-manifest.v3990_2.js?v=3990_2&r=r034-worker-1102-bounded-api';
import {
