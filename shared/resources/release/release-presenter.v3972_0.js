import { CURRENT_RELEASE } from './current-release.js?v=3972_0';
...
export function syncCurrentRelease(root = document) {
  ...
  if (doc.body) {
    ...
    if (CURRENT_RELEASE.localStrengthVersion) doc.body.dataset.localStrength = CURRENT_RELEASE.localStrengthVersion;
    if (CURRENT_RELEASE.all211Version) doc.body.dataset.all211Static = CURRENT_RELEASE.all211Version;
  }
