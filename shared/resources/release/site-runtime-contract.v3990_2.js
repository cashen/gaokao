...
import { ACTIVE_RESOURCE_MANIFEST } from './active-resource-manifest.v3990_2.js?v=3990_2&r=r036-major-history-rank-lazy';
...
export const SITE_RUNTIME_CONTRACT = Object.freeze({
  ...
  activeEntrypoints: Object.freeze({
    releaseCenter: '/shared/resources/release/current-release.js?v=3990_2&r=r036-major-history-rank-lazy',
    releasePresenter: '/shared/resources/release/release-presenter.v3990_2.js?v=3990_2',
    runtimeCache: '/shared/resources/release/runtime-cache-contract.v3990_2.js?v=3990_2&r=r036-major-history-rank-lazy',
    ...
    unifiedVisualResponsiveStyles: '/shared/ui/shell/unified-visual-responsive.v3990_3.css?v=3990_3&r=r037-unified-visual-responsive',
    ...
    majorFilterContext: '/ln-rank/js/feature/major-all/major-all-mode.v001.js?v=3990_2&context=major-filter-context-v004&r=r036-major-history-rank-lazy',
  ...
  activeEntrypointClassifications: Object.freeze({
    ...
    unifiedVisualResponsiveStyles: STABLE,
