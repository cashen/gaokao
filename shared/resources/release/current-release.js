...
export const CURRENT_RELEASE = Object.freeze({
  ...
  version: 'v3.9.65.0',
  asset: '3965_0',
  assetVersion: 'v3965_0',
  release: 'v3.9.65.0-runtime-ownership-no-fenxi',
  releaseName: 'v3.9.65.0-runtime-ownership-no-fenxi',
  label: 'runtime-ownership-no-fenxi',
  ...
  staticContentTypeOwnershipVersion: 'static-content-type-ownership-v3965_0',
  cacheRecoveryVersion: 'cached-runtime-recovery-v3965_0',
  ...
  resourceOwners: Object.freeze({
    ...
    releasePresenter: '/shared/resources/release/release-presenter.v3965_0.js',
    ...
    reportFeedbackState: '/ln-rank/js/feature/feishu/report-controller.v3965_0.js',
    ...
    selectionRuntime: '/ln-rank/js/selection-pool-runtime.v3965_0.js',
    selectionQuickEntryStructure: '/ln-rank/index.html#selectionPoolShell',
    tongxueRuntime: '/tongxue/app/tongxue-runtime-v159.js',
