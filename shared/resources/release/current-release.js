...
export const CURRENT_RELEASE = Object.freeze({
  ...
  version: 'v3.9.58.0',
  asset: '3958_0',
  assetVersion: 'v3958_0',
  release: 'v3.9.58.0-unified-resource-ownership-no-fenxi',
  releaseName: 'v3.9.58.0-unified-resource-ownership-no-fenxi',
  label: 'unified-resource-ownership-no-fenxi',
