export const AI_WORKSPACE_CONTRACT_VERSION = 'ai-workspace-contract-v3990_3';
export const AI_EVENT_CONTRACT_VERSION = 'ai-event-contract-v3990_3';
export const AI_RESULT_DELTA_VERSION = 'ai-result-delta-v3990_3';
export const AI_ACTIVE_VIEW_VERSION = 'ai-active-view-v3990_3';
...
export function applyAiWorkspaceEvent(workspaceLike, eventLike = {}) {
  ...
  if (event.type === 'selection_snapshot_imported') {
    ...
    workspace.selectionSnapshot = {
      version: clean(snapshot.version, 80) || 'ln-rank-selection-snapshot-v3990_3',
      importedAt: nowIso(),
