import '../navigation/module-navigation.v003.js?v=003'
...
import { UI_PAGE_REGISTRY, getUiPage } from '../ui-registry.v3970_0.js?v=3970_0';
import { mountFamilyPlanEntry, refreshFamilyPlanEntry } from '../components/family-plan-entry.v3990_2.js?v=3990_2';

export const FAMILY_SHELL_VERSION = 'family-shell-v3990_2';
const GENERATION = CURRENT_RELEASE.siteRuntimeGeneration;
...
const STYLE_URLS = Object.freeze([
  ...
  '/shared/ui/navigation/module-navigation.v003.css?v=003'
]);
...
function ensureUiStyles() {
  for (const href of STYLE_URLS) {
    ...
    link.rel = 'stylesheet';
    link.href = href;
    link.dataset.uiResource = GENERATION;
...
function ensureHeader(pageKey) {
  ...
  header.dataset.uiGlobalHeader = FAMILY_SHELL_VERSION;
  header.dataset.siteRuntimeGeneration = GENERATION;
...
function ensureStatus() {
  ...
  root.dataset.uiFamilyStatus = FAMILY_SHELL_VERSION;
  root.dataset.siteRuntimeGeneration = GENERATION;
...
export function mountFamilyShell() {
  ...
  document.body.dataset.siteRuntimeGeneration = GENERATION;
  ...
  globalThis.__GAOKAO_UI__ = Object.freeze({
    version: FAMILY_SHELL_VERSION,
    generation: GENERATION,
    registryVersion: UI_PAGE_REGISTRY.version || 'ui-registry-v3970_0',
