...
export const UI_RESOURCE_REGISTRY_VERSION = 'ui-resource-registry-v3990_3';
export const UI_CSS_RESOURCE_GRAPH_VERSION = 'css-resource-graph-v3990_3';
...
const classification = key => SITE_RUNTIME_CONTRACT.activeEntrypointClassifications[key] || 'declared-stable-dependency';
const stable = path => String(path || '');
const resource = (value, resourceClassification, role, owner = value) => Object.freeze({
...
export const UI_ACTIVE_RESOURCE_CLASSIFICATIONS = Object.freeze({
  familyShellJs: classification('familyShell'),
  familyShellCss: classification('familyShellStyles'),
  familyPlanEntryJs: classification('familyPlanEntry'),
  familyPlanEntryCss: classification('familyPlanEntryStyles'),
  interactionJs: classification('interactionRuntime'),
  interactionCss: classification('interactionStyles'),
  homeRuntime: classification('homeRuntime'),
  selectionBootstrap: classification('selectionBootstrap'),
  selectionRuntime: classification('selectionRuntime'),
  selectionWorkspace: classification('selectionWorkspace'),
  familyPlanBootstrap: classification('familyPlanBootstrap'),
  familyPlanRuntime: classification('familyPlanRuntime')
});
...
export const UI_STABLE_RESOURCE_REGISTRY = Object.freeze({
  ...
  minScoreEntryCss: stable('/shared/ui/components/min-score-entry.v001.css'),
...
export const UI_COMPONENT_REGISTRY = Object.freeze({
  globalShell: Object.freeze({
    ...
    classification: UI_ACTIVE_RESOURCE_CLASSIFICATIONS.familyShellJs
  }),
  familyPlanEntry: Object.freeze({
    ...
    classification: UI_ACTIVE_RESOURCE_CLASSIFICATIONS.familyPlanEntryJs,
  ...
  interactionTransaction: Object.freeze({
    ...
    nativeChooserActivationOwner: UI_ACTIVE_RESOURCE_REGISTRY.interactionJs,
    classification: UI_ACTIVE_RESOURCE_CLASSIFICATIONS.interactionJs,
    policies: Object.freeze({
      preActivationDomMutationForbidden: true,
      singlePhysicalEventFamily: true,
      tailGuardAfterOutcomeOnly: true,
      userAgentBranchForbidden: true
    })
  }),
...
export const UI_CSS_RESOURCE_GRAPH = Object.freeze([
  ...
  resource(UI_ACTIVE_RESOURCE_REGISTRY.familyShellCss, UI_ACTIVE_RESOURCE_CLASSIFICATIONS.familyShellCss, 'global-shell', UI_ACTIVE_RESOURCE_REGISTRY.familyShellJs),
  resource(UI_ACTIVE_RESOURCE_REGISTRY.familyPlanEntryCss, UI_ACTIVE_RESOURCE_CLASSIFICATIONS.familyPlanEntryCss, 'family-plan-entry', UI_ACTIVE_RESOURCE_REGISTRY.familyPlanEntryJs),
  resource(UI_ACTIVE_RESOURCE_REGISTRY.interactionCss, UI_ACTIVE_RESOURCE_CLASSIFICATIONS.interactionCss, 'interaction-transaction', UI_ACTIVE_RESOURCE_REGISTRY.interactionJs),
  ...
  resource(UI_STABLE_RESOURCE_REGISTRY.minScoreEntryCss, 'stable-component', 'min-score-entry', CURRENT_RELEASE.resourceOwners.minScoreNavigation),
...
export const UI_RESOURCE_POLICIES = Object.freeze({
  ...
  currentGenerationAndDeclaredStableDependenciesSeparated: true,
