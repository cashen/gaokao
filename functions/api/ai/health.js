...
export async function onRequest(context){
  ...
  return json({
    ...
    workspace:{scope:'辽宁2027备考家庭 / 2026物理类历史数据底座',productVersion:AIPLUS_PRODUCT_VERSION,productContractVersion:AIPLUS_PRODUCT_CONTRACT_VERSION,productMode:'family-advisor',deterministicFirst:true,modelMayChangeBusinessFacts:false,providerSwitchable:true,externalApiSupported:true,semanticMode:'parent-semantic-frame-v0.03',agentSemanticMode:'human-advisor-agent-kernel-v3992_6',decisionSemanticMode:'bounded-evidence-plan-v0.03',conversationMode:'continuous-human-advisor-v0.03',interruptionMode:'client-latest-write-wins-v3992_0',agentKernelVersion:AI_AGENT_KERNEL_VERSION,parentSemanticFrameVersion:PARENT_SEMANTIC_FRAME_VERSION,evidencePlanVersion:AI_EVIDENCE_PLAN_VERSION,claimEvidenceVersion:AI_CLAIM_EVIDENCE_VERSION,decisionResearchRuntimeVersion:AI_DECISION_RESEARCH_RUNTIME_VERSION},
