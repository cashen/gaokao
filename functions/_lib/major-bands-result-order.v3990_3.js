...
export const MAJOR_BANDS_RESULT_ORDER_VERSION = 'major-bands-result-order-ephemeral-v3990_3';
export const MAJOR_BANDS_RANKING_MEMORY_MODE = 'ephemeral-compact-tuples-v3990_3';
...
export function majorBandsSnapshotId(records = [], queryIdentity = '') {
  ...
  return `v3990_3-${records.length}-${hash.toString(16).padStart(8, '0')}`;
}
