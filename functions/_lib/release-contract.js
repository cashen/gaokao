export const LN_RANK_RELEASE_CONTRACT = {
  display: 'v3.9.46.4',
  asset: '3946_4',
  assetVersion: 'v3946_4',
  release: 'v3.9.46.4-ln-rank-local-strength-miss-proof-regression-12-role-no-fenxi',
  label: 'local-strength-miss-proof-regression-12-role-no-fenxi',
