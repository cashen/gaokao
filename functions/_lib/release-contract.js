export const LN_RANK_RELEASE_CONTRACT = {
  display: 'v3.9.47.0',
  asset: '3947_0',
  assetVersion: 'v3947_0',
  release: 'v3.9.47.0-ln-rank-major-kb-layered-ui-human-regression-12-role-no-fenxi',
  label: 'major-kb-layered-ui-human-regression-12-role-no-fenxi',
