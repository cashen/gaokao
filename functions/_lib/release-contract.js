export const LN_RANK_RELEASE_CONTRACT = {
  display: 'v3.9.46.5',
  asset: '3946_5',
  assetVersion: 'v3946_5',
  release: 'v3.9.46.5-ln-rank-school-strength-local-211-view-regression-12-role-no-fenxi',
  label: 'school-strength-local-211-view-regression-12-role-no-fenxi',
