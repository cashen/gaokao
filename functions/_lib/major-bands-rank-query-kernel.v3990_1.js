import { matchRegion } from './major-filter.v3990_1.js';
import {
...
export const MAJOR_BANDS_RANK_QUERY_KERNEL_VERSION = 'major-bands-rank-query-kernel-v3990_1';
export const MAJOR_BANDS_RANK_QUERY_MEMORY_MODE = 'requested-band-lightweight-order-current-page-v3990_1';
...
function emptyResult(candidateRank, keywordQuery, requestedBand = '') {
  return {
    ...
    stats: {
      ...
      rankingCandidateMode: 'lightweight-order-current-page-v3990_1',
  ...
  return {
    ...
    stats: {
      ...
      rankingCandidateMode: deferResponseEnrichment
        ? 'lightweight-order-current-page-v3990_1'
        : 'full-keyword-candidate-v3990_1',
