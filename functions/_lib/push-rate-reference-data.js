...
export const PUSH_RATE_REFERENCE = [
  ...
  { schoolName: '西南交通大学', province: '四川', tags: ['211', '双一流', '交通'], sourceLevel: 'C', recommendQuotaText: '第三方称约1352名，约19.0%', schoolPushRateText: '约19%（第三方，待复核）', pushOpportunityLevel: 'high', confidence: 'low-medium', notes: ['交通行业强校；环境学院有12名免研名额官方片段，专业分母待补。'], collegeSignals: [{ name: '环境科学与工程学院', quotaText: '约12名，需补毕业生分母' }], majorLevelStatus: 'need_manual_check' },
  ...
  { schoolName: '中国地质大学（北京）', aliases: ['中国地质大学北京'], province: '北京', tags: ['211', '双一流', '地质'], sourceLevel: 'C', schoolPushRateText: '约25.5%（第三方，待复核）', pushOpportunityLevel: 'high', confidence: 'low-medium', notes: ['地质行业强校；环境学院等有方案线索但不可直接算专业率。'], majorLevelStatus: 'need_manual_check' },
  ...
  { schoolName: '中国石油大学（华东）', aliases: ['中国石油大学华东'], province: '山东', tags: ['211', '双一流', '石油'], sourceLevel: 'C', schoolPushRateText: '约21%（第三方，待复核）', pushOpportunityLevel: 'high', confidence: 'low-medium', notes: ['石油行业强校，升学/行业就业都需结合专业。'], majorLevelStatus: 'need_manual_check' },
  ...
  { schoolName: '河海大学', province: '江苏', tags: ['211', '双一流', '水利'], sourceLevel: 'C', recommendQuotaText: '第三方称约1047/1048名，约19.55%~19.57%', schoolPushRateText: '约19.5%（第三方，待复核）', pushOpportunityLevel: 'high', confidence: 'low-medium', notes: ['水利强校，需核验大禹学院/水利等方向。'], majorLevelStatus: 'need_manual_check' }
];
