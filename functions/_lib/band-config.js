export const RANGE_PRESETS = {
  standard: {
    ...
    bands: {
      ...
      near: { title: '重点匹配', minDelta: -10, maxDelta: 0, desc: '和孩子分数更接近，是主要讨论区。' },
  ...
  wide: {
    ...
    bands: {
      ...
      near: { title: '重点匹配', minDelta: -15, maxDelta: 0, desc: '扩大重点匹配范围，便于补充更多讨论对象。' },
  ...
  safe: {
    ...
    bands: {
      ...
      near: { title: '重点匹配', minDelta: -10, maxDelta: 0, desc: '保留接近分数的主要讨论区。' },
