...
export const MAJOR_BANDS_RANK_BUCKET_LOADER_VERSION = 'major-bands-rank-bucket-loader-bounded-all-band-v3990_1';
...
export async function loadMajorBandsRankWindow(context, selectedBuckets = [], options = {}) {
  ...
  if (!buckets.length) {
    return {
      ...
      stats: {
        ...
        projectionVersion: options.projection || 'full-record-v3990_1',
  ...
  return {
    ...
    stats: {
      ...
      pageIdFilterCount: options.allowedIds instanceof Set ? options.allowedIds.size : 0,
      pageIdFilterVersion: 'major-bands-page-id-predecode-filter-v3990_1',
      projectionVersion: results[0]?.loaded?.projectionVersion || options.projection || 'full-record-v3990_1',
