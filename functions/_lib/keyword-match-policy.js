...
export const KEYWORD_MATCH_POLICIES = {
  ...
  '食品': p({ key: '食品', exact: ['食品科学与工程', '食品质量与安全', '食品营养与健康'], related: ['生物工程', '酿酒工程', '乳品工程'], industry: { industryTags: ['食品'] } }),
  '生物': p({ key: '生物', exact: ['生物工程', '生物技术', '生物科学', '生物制药'], related: ['食品科学与工程', '药学', '制药工程'], industry: { industryTags: ['生物'] } }),
