export const STATUS_RULES = [
  ...
  { min: -15, max: -6, key: 'steady', label: '稳妥参考', position: '主体偏稳' },
  { min: -5, max: 3, key: 'match', label: '匹配参考', position: '主体讨论' },
...
export function getStatus(delta) {
  ...
  return STATUS_RULES.find((r) => (r.min === undefined || value >= r.min) && (r.max === undefined || value <= r.max)) || STATUS_RULES[4];
}
