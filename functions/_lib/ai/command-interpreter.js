...
function cleanSchoolAliasCandidate(value){return clean(value,40).replace(/^(?:那|再|还是|然后|顺便|等等|等下|算了|先|换成|换|改成|改看|看看|看下|看一下|帮我看|帮我查|我想看|我想查|我想问|想看|想查|想问|我想知道|想知道|查下|查一下|问下|问一下|请看|请查)+/,'').replace(/(?:的|呢|吗|呀|啊|吧)+$/g,'').replace(/[\s，,。！？!?；;：:]+/g,'').trim();}
