...
const EXPECTED_BUILD='tongxue-v156-direct-result-20260723';
...
installShareMetadataStabilizer('v1.5.6');
installTongxueShare({pageVersion:'v1.5.6'});
installSchoolPortrait({pageVersion:'v1.5.6'});
refreshTongxueCopyV152();
