...
const EXPECTED_BUILD='tongxue-v158-cache-recovery-20260725';
...
installShareMetadataStabilizer('v1.5.8');
installTongxueShare({pageVersion:'v1.5.8'});
installSchoolPortrait({pageVersion:'v1.5.8'});
refreshTongxueCopyV152();
