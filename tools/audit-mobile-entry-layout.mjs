...
const mainCss = fs.readFileSync(path.join(lr, assets.cssDist?.main || 'css/dist/ln-rank-main.v3933_7.css'),'utf8');
const localCss = fs.readFileSync(path.join(lr, assets.cssDist?.localMainline || 'css/dist/local-mainline.v3933_7.css'),'utf8');
