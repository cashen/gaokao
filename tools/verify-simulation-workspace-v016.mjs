...
for (const src of [
  '/ln-rank/js/simulation-report-v015-human-workbench.js?v=v016.15-r105',
  '/ln-rank/js/simulation-report-v016-legacy-render-guard.js?v=v016.15-r105',
  '/ln-rank/js/simulation-report-v016-pdf.js?v=v016.15-r105'
...
assert.equal(manifest.version,'simulation-workspace-v016.15');
assert.equal(manifest.revision,'r105-guard-contract-final');
...
console.log('simulation-workspace-v016.15 contract: PASS');
