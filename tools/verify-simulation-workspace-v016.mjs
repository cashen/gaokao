...
assert.match(html,/simulation-report-v015-human-workbench\\.js\\?v=v016\\.3-r093/);
...
assert.equal(manifest.version,'simulation-workspace-v016.3');
assert.equal(manifest.revision,'r093-cache-buster-and-regression-contract');
...
assert.doesNotMatch(browser,/家庭判断：/);
console.log('simulation-workspace-v016.3 contract: PASS');
