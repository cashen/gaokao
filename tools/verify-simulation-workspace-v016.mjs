...
assert.match(html,/simulation-report-v015-human-workbench\\.js\\?v=v016\\.6-r096/);
assert.match(html,/simulation-report-v016-pdf\\.js\\?v=v016\\.6-r096/);
...
assert.equal(manifest.version,'simulation-workspace-v016.6');
assert.equal(manifest.revision,'r096-final-compat-sync-pdf');
...
console.log('simulation-workspace-v016.6 contract: PASS');
