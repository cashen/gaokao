...
assert.match(html,/simulation-report-v015-human-workbench\\.js\\?v=v016\\.8-r098/);
assert.match(html,/simulation-report-v016-legacy-render-guard\\.js\\?v=v016\\.8-r098/);
assert.match(html,/simulation-report-v016-pdf\\.js\\?v=v016\\.8-r098/);
...
assert.equal(manifest.version,'simulation-workspace-v016.8');
assert.equal(manifest.revision,'r098-final-human-input-pdf-compat');
...
console.log('simulation-workspace-v016.8 contract: PASS');
