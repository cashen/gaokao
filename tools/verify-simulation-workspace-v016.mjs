...
for(const src of ['/ln-rank/js/simulation-report-v016-legacy-render-guard.js?v=v016.33-r123','/ln-rank/js/simulation-report-v016-pdf.js?v=v016.33-r123','/ln-rank/js/simulation-report-v017-responsive-input.js?v=v016.33-r123']) assert.ok(html.includes(src),`html missing ${src}`);
...
assert.equal(manifest.version,'simulation-workspace-v016.33');assert.equal(manifest.revision,'r123-real-backspace-gate');
...
console.log('simulation-workspace-v016.33 contract: PASS');
