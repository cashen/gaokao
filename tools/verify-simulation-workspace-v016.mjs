...
for(const src of ['/ln-rank/js/simulation-report-v016-legacy-render-guard.js?v=v016.30-r120','/ln-rank/js/simulation-report-v016-pdf.js?v=v016.30-r120','/ln-rank/js/simulation-report-v017-responsive-input.js?v=v016.30-r120']) assert.ok(html.includes(src),`html missing ${src}`);
...
assert.equal(manifest.version,'simulation-workspace-v016.30');assert.equal(manifest.revision,'r120-responsive-input-main-thread-clean');
...
assert.ok(legacyPdf.includes('待核实')||legacyPdf.includes('核对与提醒'),'legacy reminder layer remains compatible');
console.log('simulation-workspace-v016.30 contract: PASS');
