...
for (const src of [
  '/ln-rank/js/simulation-report-v015-human-workbench.js?v=v016.20-r110',
  '/ln-rank/js/simulation-report-v016-legacy-render-guard.js?v=v016.20-r110',
  '/ln-rank/js/simulation-report-v016-pdf.js?v=v016.20-r110',
  '/ln-rank/js/simulation-report-v017-responsive-input.js?v=v016.20-r110'
]) assert.ok(html.includes(src), `html missing ${src}`);
assert.equal(manifest.version,'simulation-workspace-v016.20');
assert.equal(manifest.revision,'r110-responsive-input-school-major-cache');
...
assert.ok(responsive.includes("new Worker('/ln-rank/js/simulation-school-search-worker-v001.js?v=v016.20-r110',{type:'module'})"));
...
console.log('simulation-workspace-v016.20 contract: PASS');
