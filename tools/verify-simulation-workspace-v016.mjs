...
for(const src of ['/ln-rank/js/simulation-report-v016-legacy-render-guard.js?v=v016.32-r122','/ln-rank/js/simulation-report-v016-pdf.js?v=v016.32-r122','/ln-rank/js/simulation-report-v017-responsive-input.js?v=v016.32-r122']) assert.ok(html.includes(src),`html missing ${src}`);
...
assert.equal(manifest.version,'simulation-workspace-v016.32');assert.equal(manifest.revision,'r122-ime-paste-real-gate');
...
console.log('simulation-workspace-v016.32 contract: PASS');
