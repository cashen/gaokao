...
const siteRuntime = read('shared/resources/release/site-runtime-contract.v3990_2.js');
const cache = read('shared/resources/release/runtime-cache-contract.v3990_2.js');
const execution = read('shared/governance/resource-execution-contract.v3990_2.js');
const activeGeneration = JSON.parse(read('ln-rank/site-active-generation.v3990_2.json'));
const aiplusApp = read('aiplus/app.v3990_2.js');
const majorSourceProfile = read('ln-rank/kb/major-understanding/major-source-profile.generated.js');

requireText(release, "version: 'v3.9.90.2'", 'canonical release');
requireText(release, "siteRuntimeGeneration: 'v3990_2'", 'canonical runtime generation');
requireText(release, "asset: '3990_2'", 'canonical asset query');
requireText(release, "activeResourceManifestVersion: 'active-resource-manifest-v3990_2'", 'canonical manifest identity');

requireText(manifest, "ACTIVE_RESOURCE_MANIFEST_VERSION = 'active-resource-manifest-v3990_2'", 'active manifest version');
...
for (const file of publicPages) {
  ...
  requireText(html, 'data-release="v3.9.90.2"', file + ' public release');
  requireText(html, 'data-site-runtime-generation="v3990_2"', file + ' runtime generation');
}
requireText(read('index.html'), 'family-home.v3990_2.js?v=3990_2', 'home entrypoint');
requireText(read('ln-rank/index.html'), 'app.v3990_2.js?v=3990_2', 'selection entrypoint');
requireText(read('ln-rank/selection-pool.html'), 'selection-pool.v3990_2.js?v=3990_2', 'plan entrypoint');
requireText(read('aiplus/index.html'), 'app.v3990_2.js?v=002_4&scroll=002_1&fdw=003_0&focus=006_0', 'AIPLuS entrypoint');
...
console.log('resource-consistency-v3990_2: PASS');
