...
if(meta.version!=='v3.9.14.1'||meta.assetVersion!=='v3914') fail('release-meta version mismatch');
...
const kbPresetModule=await import(path.join(root,'functions/_lib/kb/major-filter-preset-kb.generated.js'));
const kbWords=(kbPresetModule.MAJOR_FILTER_PRESET_KB?.groups||[]).flatMap(g=>g.words||[]);
if(kbWords.includes('定向')||kbWords.includes('公费师范')) fail('KB groups still displays targeted/public teacher entries');
...
console.log('OK v3914.1 release check passed');
