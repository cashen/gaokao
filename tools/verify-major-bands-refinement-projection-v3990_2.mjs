...
import { scopeMajorBandsRankBucketsForRequest } from '../functions/_lib/major-bands-rank-bucket-loader.v3990_2.js';
import {
...
console.log(JSON.stringify({
  version: 'major-bands-refinement-projection-v3990_2',
  checkedRows,
  cases,
  scores,
  presets,
