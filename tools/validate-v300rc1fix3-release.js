...
for (const f of files) {
  const s = read(f);
  assert(s.includes('v300rc1fix3-20260512'), f + ' missing rc1fix3 stamp');
...
assert(read('fenxi/v3/assets/js/adapters/release-readiness-adapter.v3.js').includes('rc1fix3-qualification-filter-guard'), 'release readiness stage not updated');
console.log('All V3.0.0.rc1.fix3 checks passed.');
