...
const [page,entry,copy,portrait,headers,primary,source]=await Promise.all([
 ...
 readFile('tongxue/app/tongxue-performance-v156.js','utf8'),
...
check('页面版本',page.includes('同学你好 v1.5.6')&&page.includes('./app/tongxue-performance-v156.js?v=156'));
check('品牌构建标识',count(page,'<meta name="tongxue-build" content="tongxue-v156-direct-result-20260723">')===1);
...
check('运行时构建校验',entry.includes("EXPECTED_BUILD='tongxue-v156-direct-result-20260723'")&&entry.includes("tongxue-performance-v112.js?v=156"));
check('运行时版本',entry.includes("installShareMetadataStabilizer('v1.5.6')")&&entry.includes("pageVersion:'v1.5.6'"));
...
check('品牌缓存',headers.includes('/tongxue/assets/brand/*')&&headers.includes('/tongxue/app/tongxue-performance-v156.js')&&headers.includes('/tongxue/portrait/tongxue-school-portrait-v121.js')&&headers.includes('immutable'));
