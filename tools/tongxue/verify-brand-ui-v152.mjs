...
const [page,entry,copy,portrait,headers,primary,source]=await Promise.all([
 ...
 readFile('tongxue/app/tongxue-performance-v157.js','utf8'),
...
check('页面版本',page.includes('同学你好 v1.5.7')&&page.includes('./app/tongxue-performance-v157.js?v=157'));
check('品牌构建标识',count(page,'<meta name="tongxue-build" content="tongxue-v157-family-shell-20260725">')===1);
...
check('运行时构建校验',entry.includes("EXPECTED_BUILD='tongxue-v157-family-shell-20260725'")&&entry.includes("tongxue-performance-v112.js?v=156")&&entry.includes("family-shell.v3964_0.js?v=3964_0"));
check('运行时版本',entry.includes("installShareMetadataStabilizer('v1.5.7')")&&entry.includes("pageVersion:'v1.5.7'"));
...
check('品牌缓存',headers.includes('/tongxue/assets/brand/*')&&headers.includes('/tongxue/app/tongxue-performance-v157.js')&&headers.includes('/tongxue/portrait/tongxue-school-portrait-v121.js')&&headers.includes('immutable'));
