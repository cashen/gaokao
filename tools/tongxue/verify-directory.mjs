...
const [page,changelog,legacy,home,share,resolver,wrapper,copy,portrait,rootFiles]=await Promise.all([
 readFile('tongxue/index.html','utf8'),readFile('tongxue/changelog.html','utf8'),readFile('tongxue.html','utf8'),readFile('index.html','utf8'),readFile('tongxue/share/tongxue-share-v130.js','utf8'),readFile('tongxue/data/school-name-resolver-v150.js','utf8'),readFile('tongxue/app/tongxue-performance-v154.js','utf8'),readFile('tongxue/app/tongxue-copy-v152.js','utf8'),readFile('tongxue/portrait/tongxue-school-portrait-v121.js','utf8'),readdir('.')
]);
requireText(page,'<title>同学你好 - 找学校，看看大家怎么说</title>','页面标题');
requireText(page,'./app/tongxue-performance-v154.js?v=154','页面入口');
requireText(page,'同学你好 v1.5.4 · 更新于 2026-07-21','页面版本');
requireText(page,'tongxue-v154-changelog-20260721','页面构建标识');
...
if(!(changelog.indexOf('v1.5.4')<changelog.indexOf('v1.5.3')&&changelog.indexOf('v1.5.3')<changelog.indexOf('v1.5.2')&&changelog.indexOf('v1.5.2')<changelog.indexOf('v1.5.1')))failures.push('更新记录未按倒序排列');
...
requireText(wrapper,"installShareMetadataStabilizer('v1.5.4')",'运行时版本');
requireText(wrapper,"tongxue-performance-v112.js?v=154",'核心运行时缓存版本');
requireText(wrapper,'installTongxueCopyV152();','文案层安装');
requireText(wrapper,"tongxue-school-portrait-v121.js?v=154",'无副作用画像入口');
