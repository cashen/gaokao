...
await writeFile('/tmp/school-entities-v130.mjs',await readFile('shared/resources/schools/school-identity-center.js','utf8'));await writeFile('/tmp/tongxue-summary-base-v112.mjs',await readFile('functions/_lib/tongxue-summary-base-v112.js','utf8'));await writeFile('/tmp/tongxue-summary-v130.mjs',wrapper);
