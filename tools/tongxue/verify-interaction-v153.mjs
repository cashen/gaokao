...
const [page,core,entry,copy,region,portrait]=await Promise.all([
 readFile('tongxue/index.html','utf8'),readFile('tongxue/app/tongxue-performance-v112.js','utf8'),readFile('tongxue/app/tongxue-performance-v153.js','utf8'),readFile('tongxue/app/tongxue-copy-v152.js','utf8'),readFile('tongxue/app/tongxue-region-ui-v152.js','utf8'),readFile('tongxue/portrait/tongxue-school-portrait-v121.js','utf8')
]);
...
check('文案层先于核心',entry.indexOf('installTongxueCopyV152();')<entry.indexOf("await import('./tongxue-performance-v112.js?v=153')"));
...
console.log('TONGXUE_INTERACTION_V153_RESULTS '+JSON.stringify({failures}));if(failures.length)process.exitCode=1;
