...
const wrapper=await readFile('tongxue/app/tongxue-performance-v153.js','utf8');
...
const checks={
  pageVersion:html.includes('同学你好 v1.5.3')&&html.includes('./app/tongxue-performance-v153.js?v=153'),
  ...
  keepsQueryRuntime:wrapper.includes('tongxue-performance-v112.js?v=153'),
  installsShare:wrapper.includes('installTongxueShare'),
  installsPortrait:wrapper.includes('tongxue-school-portrait-v121.js?v=153')&&wrapper.includes('installSchoolPortrait'),
