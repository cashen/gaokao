...
const wrapper=await readFile('tongxue/app/tongxue-performance-v154.js','utf8');
...
const checks={
  pageVersion:html.includes('同学你好 v1.5.4')&&html.includes('./app/tongxue-performance-v154.js?v=154'),
  ...
  keepsQueryRuntime:wrapper.includes('tongxue-performance-v112.js?v=154'),
  installsShare:wrapper.includes('installTongxueShare'),
  installsPortrait:wrapper.includes('tongxue-school-portrait-v121.js?v=154')&&wrapper.includes('installSchoolPortrait'),
