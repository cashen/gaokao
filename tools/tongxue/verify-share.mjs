...
const wrapper=await readFile('tongxue/app/tongxue-performance-v130.js','utf8');
...
await import('node:fs/promises').then(async({writeFile})=>{
  const entities=await readFile('tongxue/data/school-entities-v130.js','utf8');
...
const checks={
  pageVersion:html.includes('同学你好 v1.3.0')&&html.includes('./app/tongxue-performance-v130.js?v=130'),
  newCopy:html.includes('看看学长学姐真实聊过的')&&html.includes('看看同学怎么说'),
  keepsQueryRuntime:wrapper.includes('tongxue-performance-v112.js?v=130'),
