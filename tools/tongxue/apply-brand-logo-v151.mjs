...
async function updateShareTest(){
 ...
 source=replaceOne(source,"newCopy:html.includes('看看学长学姐真实聊过的')&&html.includes('拼音首字母')&&html.includes('看看同学怎么说')","newCopy:html.includes('看看学长学姐怎么说')&&html.includes('拼音首字母')&&html.includes('看看同学怎么说')&&html.includes('tongxue-logo-primary-v1.png')",'分享首页文案');
