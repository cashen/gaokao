...
assert.ok(entry.includes("family-shell.v3964_0.js?v=3964_0"));
...
assert.ok(page.includes('同学你好 v1.5.7'));
assert.ok(changelog.indexOf('v1.5.7') < changelog.indexOf('v1.5.6'));
