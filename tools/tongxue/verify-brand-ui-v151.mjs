...
check('Logo 图片语义',page.includes('class="hero-logo"')&&page.includes('src="./assets/brand/tongxue-logo-primary-v1.png"')&&page.includes('width="1200" height="557"')&&page.includes('alt="同学你好"')&&page.includes('fetchpriority="high"'));
...
check('PNG 文件签名',primary.subarray(0,8).equals(Buffer.from([137,80,78,71,13,10,26,10])));
check('WebP 文件签名',source.subarray(0,4).toString()==='RIFF'&&source.subarray(8,12).toString()==='WEBP');
check('页面 Logo 大小',primaryStat.size>20000&&primaryStat.size<200000);
check('概念原图大小',sourceStat.size>20000&&sourceStat.size<200000);
