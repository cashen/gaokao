...
assert.equal(MAJOR_BANDS_PREDECODE_REGION_FILTER_VERSION,'major-bands-predecode-region-filter-v3990_2');
const api=fs.readFileSync('functions/api/major-bands.js','utf8');
const loader=fs.readFileSync('functions/_lib/major-bands-rank-bucket-loader.v3990_2.js','utf8');
...
assert.ok(provider.includes("MAJOR_BANDS_RANK_ROW_NATIVE_SCAN_VERSION = 'major-bands-rank-row-native-scan-v3990_2'"));
