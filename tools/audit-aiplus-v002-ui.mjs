...
assert.match(workflow,/if \[ "\$immutable_preview" = "\$branch_preview" \]/);
assert.match(workflow,/require_text immutable-health/);
assert.match(workflow,/\$\{IMMUTABLE_PREVIEW\}\/aiplus\/\?candidate=/);
assert.match(workflow,/\$\{IMMUTABLE_PREVIEW\}\/ai\/\?candidate=/);
assert.match(workflow,/\$\{BRANCH_PREVIEW\}\/api\/ai\/school-official/);
assert.match(workflow,/\$\{BRANCH_PREVIEW\}\/api\/ai\/school-history/);
assert.match(workflow,/\$\{BRANCH_PREVIEW\}\/api\/ai\/turn/);
assert.match(workflow,/\$\{BRANCH_PREVIEW\}\/api\/ai\/model-probe/);
assert.doesNotMatch(workflow,/\$\{IMMUTABLE_PREVIEW\}\/api\/ai\/(?:school-official|school-history|turn|model-probe)/);
