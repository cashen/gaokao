...
const html=read('aiplus/index.html'),app=read('aiplus/app.v3990_1.js'),render=read('aiplus/render.v3992_0.js'),product=read('aiplus/product.v002.css'),geometry=read('aiplus/geometry.v002.css'),workspace=read('aiplus/workspace.v3990_1.css'),agent=read('aiplus/agent.v3992_0.css'),feedbackLog=read('aiplus/feedback-log.v004.js'),feedbackUi=read('aiplus/feedback-log-ui.v004.js'),selectionWorkbench=read('aiplus/selection-workbench.v005.js'),decisionFocusCss=read('aiplus/decision-focus.v006.css'),decisionFocus=read('shared/ai/decision-focus.v006_1.js'),presentation=read('functions/_lib/ai/advisor-presentation.js'),orchestrator=read('functions/_lib/ai/turn-orchestrator.js'),profileSource=read('functions/_lib/ai/school-profile-supplement-source.js'),workflow=read('.github/workflows/verify-ai-workspace-v3990_1.yml');
...
const decisionFocusAppAsset='/aiplus/app.v3990_1.js?v=002_4&scroll=002_1&fdw=003_0&focus=006_0';
...
assert.equal(coreEntryUrls.find(url=>url.searchParams.has('focus'))?.pathname,'/aiplus/app.v3990_1.js','Decision Focus cache key must terminate at the canonical app entry');
