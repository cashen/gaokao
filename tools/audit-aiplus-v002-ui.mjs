...
assert.match(html,/data-ai-plus-assets="aiplus-assets-v002_3"/);
...
const geometryAsset='/aiplus/geometry.v002.css?v=002_2&core=002_3';
...
assert.ok(coreEntryUrls.every(url=>url.searchParams.get('v')==='002_3'),`mixed core entry version transaction: ${coreEntryAssets.join(', ')}`);
...
assert.ok(moduleAssets.every(value=>value.endsWith('?v=002_3')),`mixed module cache transaction: ${moduleAssets.join(', ')}`);
