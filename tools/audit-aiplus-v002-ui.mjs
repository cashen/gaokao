...
assert.doesNotMatch(workflow,/echo "preview_base=\$branch_preview"/);
...
assert.doesNotMatch(workflow,/\$\{BRANCH_PREVIEW\}\/api\/ai\/(?:school-official|school-history|turn|model-probe)/);
