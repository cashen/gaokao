...
const expectedExecutionGateVersion = 'major-bands-query-execution-gate-v3990_2';
const expectedExecutionGateMode = 'request-owned-timer-polling';
const expectedBucketLoaderVersion = 'major-bands-rank-bucket-loader-bounded-all-band-v3990_2';
const expectedRankRowFilterVersion = 'major-bands-rank-row-filter-v3990_2';
const expectedQueryMemoryMode = 'requested-band-lightweight-order-current-page-v3990_2';
const expectedOrderIdCacheVersion = 'major-bands-requested-band-order-id-lru-v3990_2';
const expectedOrderEdgeCacheVersion = 'major-bands-requested-band-order-edge-cache-score-hints-v3990_2';
const expectedPageScoreHintVersion = 'major-bands-requested-band-page-score-hints-v3990_2';
const expectedRequestedBandResponseEdgeCacheVersion = 'major-bands-requested-band-response-edge-cache-score-hints-v3990_2';
const expectedPageIdFilterVersion = 'major-bands-page-id-predecode-filter-v3990_2';
const expectedOrderProjectionVersion = 'major-bands-rank-order-minimal-projection-v3990_2';
const expectedOrderPageSourceVersion = 'major-bands-order-page-raw-row-reuse-v3990_2';
const expectedResultOrderVersion = 'major-bands-result-order-ephemeral-v3990_2';
const expectedRankingMemoryMode = 'ephemeral-compact-tuples-v3990_2';
const expectedAllBandsExecutionMode = 'sequential-internal-band-requests-v3990_2';
const expectedAllBandsSharedProjectionVersion = 'major-bands-all-bands-shared-projection-v3990_2';
...
function validateResult(result) {
  ...
  assert.equal(result.payload?.source?.queryKernelVersion, 'major-bands-rank-query-kernel-v3990_2', `${result.scenario}: query kernel`);
  ...
  assert.equal(result.payload?.source?.rankingCandidateMode, 'lightweight-order-current-page-v3990_2', `${result.scenario}: lightweight ranking candidate`);
  ...
  assert.equal(result.payload?.source?.allBandsPageCacheReleaseMode, 'release-completed-on-requested-band-switch-v3990_2', `${result.scenario}: all-band page cache release mode`);
...
const evidence = {
  version: 'major-bands-real-concurrency-v3990_2',
  ...
  concurrencyContract: 'shared-and-distinct-query-identities-v3990_2',
