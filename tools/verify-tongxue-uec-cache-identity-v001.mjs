...
const RESULT_VIEW_IDENTITY = '/tongxue/app/tongxue-runtime-result-view-v159.js?v=159-flow006&r=r042-direct-min-score-handoff';
...
assert.ok(resultView.includes('先看这两件事'), 'result view human summary heading missing');
