export const AIPLUS_PARENT_QUERY_CATALOG_V003=Object.freeze([
  ...
  {id:'pair-choice',text:'沈工大电气和大连交通自动化怎么选，考虑就业和考研',schools:['沈阳工业大学','大连交通大学'],aliases:['沈工大','大连交通'],majors:['电气工程及其自动化','自动化'],task:'decision_research',needs:['employment','postgraduate'],rememberedScoreOnly:true},
  {id:'pair-choice-explicit-score',text:'568分，沈工大电气和大连交通自动化怎么选，考虑就业',schools:['沈阳工业大学','大连交通大学'],aliases:['沈工大','大连交通'],majors:['电气工程及其自动化','自动化'],task:'decision_research',needs:['admissions','employment'],explicitScore:true},
  ...
  {id:'shared-major-school-pair',text:'沈工大和沈航的电气怎么选，更看重就业',schools:['沈阳工业大学','沈阳航空航天大学'],aliases:['沈工大','沈航'],majors:['电气工程及其自动化'],task:'decision_research',needs:['employment'],pairShape:'schools_one_major'},
  {id:'single-school-multi-major',text:'沈航的机械、电气、测控怎么选，更看重就业',schools:['沈阳航空航天大学'],aliases:['沈航'],majors:['机械','电气工程及其自动化','测控技术与仪器'],task:'decision_research',needs:['employment'],pairShape:'one_school_majors'},
  {id:'student-signal-major-choice',text:'孩子数学不错，但不喜欢编程，也不接受倒班，电气和自动化怎么选',schools:[],majors:['电气工程及其自动化','自动化'],task:'decision_research',needs:['curriculum','employment'],studentSignals:[['math_strength','strong'],['programming_affinity','avoid'],['shift_work','avoid']]},
  ...
  {id:'region-flexible',text:'可以出省，电气和自动化怎么选，就业优先',schools:[],majors:['电气工程及其自动化','自动化'],task:'decision_research',softSignal:['region','flexible']},
