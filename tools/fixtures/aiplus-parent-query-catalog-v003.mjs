export const AIPLUS_PARENT_QUERY_CATALOG_V003=Object.freeze([
  ...
  {id:'simple-major-compare-legacy',text:'电气和机械怎么选',schools:[],majors:['电气工程及其自动化','机械'],task:'major_comparison'},
  ...
  {id:'score-suspended-decision',text:'先别管分数，电气和机械怎么选，我更看重就业',schools:[],majors:['电气工程及其自动化','机械'],task:'decision_research',needs:['employment'],scoreUsage:'suspended'},
