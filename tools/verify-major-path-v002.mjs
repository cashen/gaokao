...
const app = fs.readFileSync('major-path/app-core.v006.js','utf8');
const human = fs.readFileSync('major-path/app.v006.js','utf8');
...
assert(html.includes('data-major-path-version="major-path-v0.06"'), 'current major-path v0.06 page marker missing');
assert(html.includes('data-major-path-core-version="major-path-core-v0.06"'), 'v0.06 core marker missing');
assert(html.includes('name="major-path-core-app" content="/major-path/app-core.v006.js?v=006_0"'), 'v0.06 core app declaration missing');
assert(html.includes('/major-path/app.v006.js?v=006_0'), 'v0.06 presentation app edge missing');
...
assert(human.includes("await import('./app-core.v006.js?v=006_0')"), 'v0.06 presentation must delegate directly to the single v0.06 core runtime');
