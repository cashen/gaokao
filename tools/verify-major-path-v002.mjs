...
const human = fs.readFileSync('major-path/app.v004.js','utf8');
...
assert(html.includes('data-major-path-version="major-path-v0.04"'), 'current major-path v0.04 page marker missing');
assert(html.includes('data-major-path-core-version="major-path-v0.02"'), 'v0.02 truth core marker missing');
assert(html.includes('name="major-path-core-app" content="/major-path/app.v002.js?v=002_0"'), 'v0.02 core app declaration missing');
assert(html.includes('/major-path/app.v004.js?v=004_0'), 'v0.04 presentation app edge missing');
...
assert(human.includes("await import('./app.v002.js?v=002_0')"), 'v0.04 presentation must delegate directly to the single v0.02 truth core');
...
assert(!app.includes('fetch('), 'major path v0.02 truth core must remain deterministic/static; no runtime crawler');
