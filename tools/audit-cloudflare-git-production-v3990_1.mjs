...
const marker = JSON.parse(fs.readFileSync('shared/resources/release/cloudflare-git-deployment.v3990_1.json', 'utf8'));

assert.equal(marker.version, 'cloudflare-pages-git-production-identity-v3990_1');
assert.equal(marker.release, 'v3.9.90.1');
assert.equal(marker.generation, 'v3990_1');
...
for (const required of [
  'checks: read',
  'cloudflare-git-deployment.v3990_1.json',
  'audit-cloudflare-git-production-v3990_1.mjs',
...
console.log(JSON.stringify({
  ...
  verifierOwnership: 'single-maintained-v3990_0-algorithm-runtime-mapped-to-v3990_1',
