...
} from '../shared/ui/ui-resource-registry.v3972_6.js';
...
assert.equal(CURRENT_RELEASE.resourceOwners.uiResourceRegistry, '/shared/ui/ui-resource-registry.v3972_6.js');
...
for (const item of UI_CSS_RESOURCE_GRAPH) {
  ...
  if (item.classification === 'current-generation') {
    assert.ok(item.path.includes('.v3972_6.'), `current CSS is not v3972_6: ${item.path}`);
  }
}
...
for (const marker of [
  "current-release.js?v=3972_6",
  "ui-resource-registry.v3972_6.js?v=3972_6",
