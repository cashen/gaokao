...
assert.equal(CURRENT_RELEASE.version, 'v3.9.90.0');
assert.equal(CURRENT_RELEASE.assetReleaseVersion, 'v3.9.90.0');
assert.equal(CURRENT_RELEASE.assetVersion, 'v3990_0');
assert.equal(CURRENT_RELEASE.siteRuntimeGeneration, 'v3990_0');
assert.equal(CURRENT_RELEASE.asset, '3990_0');
assert.equal(CURRENT_RELEASE.siteRuntimeContractVersion, 'site-runtime-coherence-v3990_0');
assert.equal(CURRENT_RELEASE.resourceExecutionVersion, 'resource-execution-v3990_0');
assert.equal(CURRENT_RELEASE.runtimeCacheVersion, 'runtime-cache-coherence-v3990_0');
assert.equal(CURRENT_RELEASE.selectionWorkspaceVersion, 'selection-workspace-orchestration-v3990_0');
assert.equal(CURRENT_RELEASE.interactionVersion, 'interaction-transaction-v3990_0');
assert.equal(CURRENT_RELEASE.nativeChooserActivationVersion, 'native-chooser-activation-integrity-v3990_0');
...
assert.equal(CURRENT_RELEASE.productionResourceGraphVerificationVersion, 'production-resource-graph-verification-v3990_0');
...
assert.equal(CURRENT_RELEASE.majorBandsOrchestrationVersion, 'major-bands-single-worker-rank-window-v3990_0');
assert.equal(CURRENT_RELEASE.majorBandsBucketCacheVersion, 'major-bands-rank-bucket-cache-v3990_0');
assert.equal(CURRENT_RELEASE.majorBandsRankIndexVersion, 'major-bands-rank-index-v3990_0');
assert.equal(CURRENT_RELEASE.majorBandsQueryKernelVersion, 'major-bands-rank-query-kernel-v3990_0');
assert.equal(CURRENT_RELEASE.majorBandsPaginationVersion, 'stable-full-id-snapshot-v3990_0');
assert.equal(CURRENT_RELEASE.majorBandsStableWorkerVersion, 'major-bands-bounded-fanout-v3972_5');
assert.equal(CURRENT_RELEASE.resourceOwners.majorBandsRankIndex, '/functions/_lib/major-bands-rank-index.v3990_0.js');
assert.equal(CURRENT_RELEASE.resourceOwners.majorBandsOrchestrator, '/functions/_lib/major-bands-rank-query-kernel.v3990_0.js');
...
for (const marker of [
  ...
  '/shared/ui/interaction/interaction-transaction.v3990_0.css?v=3990_0',
  '/shared/ui/interaction/interaction-transaction.v3990_0.js?v=3990_0',
  '/ln-rank/js/app.v3990_0.js?v=3990_0',
  '<span data-current-release>v3.9.90.0</span>'
