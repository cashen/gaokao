...
const requiredStylePath = new URL('../ln-rank/css/score-converter.v3990_3.css', import.meta.url);
if (!fs.existsSync(requiredStylePath)) {
  throw new Error('score converter active stylesheet is missing: ln-rank/css/score-converter.v3990_3.css');
}
...
const generatedPath = new URL('./.audit-score-equivalence-v3990_3.generated.mjs', import.meta.url);
