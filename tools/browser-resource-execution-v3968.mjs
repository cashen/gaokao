...
const artifactDir = process.env.V3968_ARTIFACT_DIR || '/tmp/v3968-resource-execution-browser';
...
try {
  for (const testCase of cases) {
    ...
    try {
      ...
      assert.equal(runtime.release, 'v3.9.68.0');
      assert.equal(runtime.workspace, 'selection-workspace-orchestration-v3967_0');
      assert.equal(runtime.school, 'school-all-mode-v3967_0');
