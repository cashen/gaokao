...
const sourcePath = new URL('./browser-native-chooser-activation-v3990_0.mjs', import.meta.url);
const generatedPath = new URL('./.browser-native-chooser-activation-v3990_0.generated.mjs', import.meta.url);
