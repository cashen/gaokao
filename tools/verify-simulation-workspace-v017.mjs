...
assert.equal(manifest.version,'simulation-workspace-v016.52');
assert.equal(manifest.revision,'r142-home-entry-and-page-version');
...
console.log('simulation-workspace-v016.52 contract: PASS');
