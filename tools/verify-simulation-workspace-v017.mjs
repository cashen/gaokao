...
for(const expected of ['input synchronous work exceeded 100ms','input p95 exceeded 60ms','沈阳工业大学','自动化']) assert.ok(performance.includes(expected),`performance gate missing ${expected}`);
