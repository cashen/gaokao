...
assert.equal(manifest.version,'simulation-workspace-v016.49');
assert.equal(manifest.revision,'r139-resolver-recovery');
...
console.log('simulation-workspace-v016.49 contract: PASS');
