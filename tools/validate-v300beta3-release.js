...
assert(version.includes('V3.0.0.beta3｜复核任务清单与家长端收口版'), 'version name missing');
assert(version.includes('v300beta3-20260512'), 'version stamp missing');
assert(version.includes('ln-v3-beta3'), 'body class missing');
...
['fenxi/v3/index.html','fenxi/v3/debug.html','fenxi/v3/index.htm','fenxi/v3/debug.htm','fenxi/v3/debug/index.html'].forEach(file => {
  ...
  assert(html.includes('v300beta3-20260512'), `${file} cache stamp missing`);
...
assert(debug.includes('V3.0.0.beta3'), 'debug beta3 version check missing');
...
console.log('All V3.0.0.beta3 checks passed.');
