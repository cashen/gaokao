...
try {
  for (const testCase of cases) {
    ...
    try {
      ...
      assert.equal(await page.locator('body').getAttribute('data-release'), 'v3.9.70.1');
...
console.log(JSON.stringify({ ok: true, contract: 'family-action-browser-v3970_0', release: 'v3.9.70.1', cases: results }, null, 2));
