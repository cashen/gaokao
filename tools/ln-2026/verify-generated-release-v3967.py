...
check('major-difficulty-2026.v3967_0.js' in unified,'difficulty current UI orchestration wrapper')
check('major-difficulty-2026.v3966_0.js' not in unified and 'major-difficulty-2026.v3965_0.js' not in unified,'difficulty legacy wrapper must not remain active')
difficulty_wrapper=(ROOT/'ln-rank/js/major-difficulty-2026.v3967_0.js').read_text(encoding='utf-8')
check('major-difficulty-2026-core.v3967_0.js' in difficulty_wrapper,'governed score-band core behind current UI wrapper')
check('shared/resources/release/release-presenter.v3967_0.js?v=3967_0' in difficulty_wrapper,'difficulty shared release presenter')
check('shared/ui/shell/family-shell.v3965_0.js?v=3965_0' in difficulty_wrapper,'difficulty current shared UI shell')
release_presenter=(ROOT/'shared/resources/release/release-presenter.v3967_0.js').read_text(encoding='utf-8')
check('current-release.js?v=3967_0' in release_presenter,'difficulty current shared release owner')
check((ROOT/'ln-rank/js/major-difficulty-2026.v3966_0.js').exists(),'difficulty previous immutable wrapper preserved')
...
print(json.dumps({'ok':True,'records':count,'strictCompleteCount':analysis['strictCompleteCount'],'analysisVersion':analysis['version'],'releasePresentation':'shared-current-release-v3967_0','zyRelations':zy.get('relations')},ensure_ascii=False))
