...
def verify_family_and_ui_v3961() -> None:
    ...
    contains('ln-rank/index.html', '确认孩子的位置', '说清想看什么', '圈出并整理专业', '家庭逐项复核', '/ln-rank/js/app.v3961_0.js?v=3962_0', '/ln-rank/css/selection-workspace.v3961_0.css?v=3961_0', 'data-release="v3.9.62.1"', 'data-current-release', '资源、UI与算法：全站统一调度')
    ...
    contains('ln-rank/js/feature/school-majors/school-all-mode.v3962_1.js', 'resolveCompactSchoolResource', 'createSelectionPoolAdapter', "const API_PATH = '/api/school-majors'", 'school-all-mode-v3962_1_1_1_1')
...
def verify_shared_resources_v3961() -> None:
    contains('shared/resources/release/current-release.js', "display: 'v3.9.62.1'", "assetVersion: 'v3962_1'", "uiOrchestrationVersion: 'ui-orchestration-v3961'", "selectionWorkspaceVersion: 'selection-workspace-orchestration-v3961'", "algorithmOrchestrationVersion: 'algorithm-orchestration-v3960'", "algorithms: '/shared/algorithms/algorithm-registry.js'")
...
def verify_release_meta_v3961() -> None:
    ...
    base.check('js/feature/school-majors/school-all-mode.v3962_1.js' in active['jsEntry'], 'school-all JS not active')
    base.check('css/school-all-mode.v3962_1.css' in active['cssEntry'], 'school-all CSS not active')
    base.check('js/feature/school-majors/school-all-mode.v3962_1.js' in active['jsEntry'], 'school-all JS not active')
    base.check('css/school-all-mode.v3962_1.css' in active['cssEntry'], 'school-all CSS not active')
    base.check('js/feature/school-majors/school-all-mode.v3962_1.js' in active['jsEntry'], 'school-all JS not active')
...
if __name__ == '__main__':
    v3.main()
    print('LN 2026 v3.9.62.1 selection workspace orchestration verification passed')
