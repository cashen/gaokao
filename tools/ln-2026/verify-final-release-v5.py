...
def verify_family_and_ui_v3962_2() -> None:
    ...
    contains(
        ...
        '圈出并整理专业',
        '家庭逐项复核',
        '/ln-rank/js/app.v3961_0.js?v=3962_2',
    ...
    contains('ln-rank/js/app.v3961_0.js', 'release-presenter.js?v=3962_2', 'shared/ui/shell/family-shell.v3961_0.js', 'ALGORITHM_CONTRACT', 'isPublicBottomLineVisible', 'school-all-mode.v3962_2.js?v=3962_2')
    ...
    contains(
        'ln-rank/js/feature/school-majors/school-all-mode.v3962_2.js',
...
def verify_zy2026_v3962_2() -> None:
...
def verify_release_meta_v3962_2() -> None:
    ...
    for meta in (release, active):
        ...
        base.check(meta['sharedResourceCenterVersion'] == 'v3962_2', 'shared resource version')
    ...
    for entry in (
        ...
        'js/feature/school-majors/school-all-mode.v3962_2.js',
...
v3.verify_family_and_ui = verify_family_and_ui_v3962_2
v3.verify_shared_resources = verify_shared_resources_v3962_2
v3.verify_zy2026 = verify_zy2026_v3962_2
v3.verify_release_meta = verify_release_meta_v3962_2
