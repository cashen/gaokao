...
def verify_family_and_ui_v3961() -> None:
    ...
    contains('ln-rank/js/feature/school-majors/school-all-mode.v3962_1.js', 'resolveCompactSchoolResource', 'createSelectionPoolAdapter', "const API_PATH = '/api/school-majors'", 'school-all-mode-v3962_1')
