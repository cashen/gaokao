...
def verify_family_and_ui_v3962_1() -> None:
    ...
    contains(
        ...
        '圈出并整理专业',
        '家庭逐项复核',
        '/ln-rank/js/app.v3961_0.js?v=3962_1',
        '/ln-rank/css/selection-workspace.v3961_0.css?v=3961_0',
        '/ln-rank/css/school-all-mode.v3962_1.css?v=3962_1',
        '/shared/ui/tokens/semantic.v3959_0.css?v=3962_1',
        'data-release="v3.9.62.1"',
    ...
    contains('ln-rank/selection-pool.html', 'id="selected-list"', 'id="family-review"', '检查已选专业', '生成家庭复核报告', '同一算法快照', '/ln-rank/js/selection-pool.v3960_0.js?v=3961_0', 'data-release="v3.9.62.1"', 'data-current-release')
    ...
    contains('ln-rank/js/app.v3961_0.js', 'release-presenter.js?v=3962_1', 'shared/ui/shell/family-shell.v3961_0.js', 'ALGORITHM_CONTRACT', 'isPublicBottomLineVisible', 'school-all-mode.v3962_1.js?v=3962_1')
    ...
    contains(
        'ln-rank/js/feature/school-majors/school-all-mode.v3962_1.js',
    ...
    school_runtime = base.text('ln-rank/js/feature/school-majors/school-all-mode.v3962_1.js')
    ...
    contains(
        'ln-rank/css/school-all-mode.v3962_1.css',
    ...
    school_css = base.text('ln-rank/css/school-all-mode.v3962_1.css')
    ...
    contains('tools/audit-school-ui-governance-v3962_1.mjs', 'school-ui-governance-v3962_1', 'sharedActionCopy', 'fullRowDetails', 'containerResponsive')
    contains('tools/browser-school-ui-v3962_1.mjs', 'pc-1440', 'pad-820', 'android-412', 'android-360-large-text', 'documentOverflow', 'singleExpanded')


def verify_shared_resources_v3962_1() -> None:
    contains(
...
def verify_zy2026_v3962_1() -> None:
...
def verify_release_meta_v3962_1() -> None:
    ...
    for meta in (release, active):
        base.check(meta['version'] == 'v3.9.62.1' and meta['assetVersion'] == 'v3962_1', 'release version')
        for key in required:
            base.check(meta.get(key) is True, f'missing contract {key}')
        base.check(meta['sharedResourceCenterVersion'] == 'v3962_1', 'shared resource version')
        ...
        base.check(meta['schoolAllModeVersion'] == 'school-all-mode-v3962_1', 'school-all version')
        base.check(meta['schoolUiGovernanceVersion'] == 'school-ui-governance-v3962_1', 'school UI governance version')
    ...
    for entry in (
        'js/app.v3961_0.js',
        'js/workspace/selection-workspace-orchestrator.v3961_0.js',
    ...
    base.check('css/school-all-mode.v3962_1.css' in active['cssEntry'], 'school-all CSS not active')
...
v3.verify_family_and_ui = verify_family_and_ui_v3962_1
v3.verify_shared_resources = verify_shared_resources_v3962_1
v3.verify_zy2026 = verify_zy2026_v3962_1
v3.verify_release_meta = verify_release_meta_v3962_1

if __name__ == '__main__':
    v3.main()
    print('LN 2026 v3.9.62.1 school UI governance verification passed')
