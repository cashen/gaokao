...
check('major-difficulty-2026.v3963_1.js' in unified,'difficulty UI orchestration wrapper')
difficulty_wrapper=(ROOT/'ln-rank/js/major-difficulty-2026.v3963_1.js').read_text(encoding='utf-8')
check('major-difficulty-2026.v3953_0.js' in difficulty_wrapper,'ascending score-band core behind UI wrapper')
check('shared/ui/shell/family-shell.v3963_1.js?v=3963_1' in difficulty_wrapper,'difficulty shared UI shell')
release_compat=(ROOT/'shared/ui/shell/family-shell.v3963_1.js').read_text(encoding='utf-8')
check('current-release.js?v=3963_1' in release_compat,'difficulty shared release owner')
