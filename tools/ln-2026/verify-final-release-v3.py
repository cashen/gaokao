...
def verify_card_ai_2026() -> None:
    ...
    contains('functions/_lib/ai-card-rules.js', '2026最低投档：', '核验2027招生计划')
    combined = base.text('functions/_lib/ai-card-prompt.js') + base.text('functions/_lib/ai-card-rules.js') + base.text('functions/_lib/ai-card-output-schema.js')
    base.check('核验2026招生计划' not in combined, 'AI still asks to verify 2026 plan')
