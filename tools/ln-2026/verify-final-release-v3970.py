...
for marker in [
 "display: 'v3.9.71.1'", "version: 'v3.9.71.1'", "assetVersion: 'v3970_0'", "assetReleaseVersion: 'v3.9.70.0'",
 ...
 "localStrengthVersion: 'local-strength-v3971_1'", "localStrengthApiVersion: 'local-strength-api-v3971_0'",
 "localStrengthIndexVersion: 'local-strength-index-v3971_0'", "localStrengthPage: '/ln-rank/local-mainline.html'"
...
required=[
 ...
 'shared/resources/release/release-presenter.v3971_0.js','shared/resources/release/release-presenter.v3971_1.js',
 ...
 'ln-rank/js/local-strength/local-strength-app.v3971_1.js','ln-rank/css/local-strength.v3971_1.css',
...
for marker in ['data-release="v3.9.71.1"','family-shell.v3970_0.css?v=3970_0','family-plan-entry.v3970_0.css?v=3970_0','family-home.v3970_0.js?v=3970_0','家庭方案与逐项复核','data-home-industry-map-entry','href="/Public_company/"','全国上市公司产业落地图']:
...
for marker in ['data-release="v3.9.71.1"','local-strength.v3971_1.css?v=3971_1','local-strength-app.v3971_1.js?v=3971_1','release-presenter.v3971_1.js?v=3971_1','全部背景专业','按学校查询','按分数位置看','没有具体分数？按分数段浏览']:
...
print(json.dumps({'ok':True,'version':'v3.9.71.1','assetReleaseVersion':'v3.9.70.0','requiredFiles':len(required),'homeRuntime':'family-home-runtime-v3970_0','localStrength':'local-strength-v3971_1','localStrengthApi':'local-strength-api-v3971_0','industryMap':'/Public_company/','homeHtmlCache':'revalidate','homeRuntimeCache':'immutable','admissionSchools':admission.get('schoolCount'),'admissionRecords':admission.get('admissionRecordCount')},ensure_ascii=False,indent=2))