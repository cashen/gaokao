...
assert.match(runtime, /school-all-mode\.v3969_2\.js\?v=3969_2&r=r030-filter-state/);
...
assert.match(release, /lnRankCacheRevision: 'r030-filter-state'/);
...
console.log(JSON.stringify({
  ...
  cacheRevision: 'r030-filter-state'
}, null, 2));
