...
if(!index.includes('V2.9.6.fix1｜入口启动与诊断补全修正版')) throw new Error('version text missing in index');
...
['assets/interaction-policy.v296fix1.js','assets/refresh-scheduler.v296fix1.js','assets/state-snapshot.v296fix1.js','assets/candidate-cache.v296fix1.js','assets/drawer.v296fix1.js','assets/child-interest-runtime.v296fix1.js','assets/child-interest-ui.v296fix1.js','assets/scenario-ui.v296fix1.js','assets/abc-view.v296fix1.js','assets/app.v296fix1.js'].forEach(f=>must('fenxi/'+f));
const app=read('fenxi/assets/app.v296fix1.js');
...
console.log('V2.9.6.fix1 validation passed');
