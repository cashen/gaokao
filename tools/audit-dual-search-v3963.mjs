...
const scoreRenderer = read('ln-rank/js/feature/major-pool/render.v3963_0.js');
...
const uiRegistry = read('shared/ui/ui-registry.v3963_0.js');
...
assert.equal(CURRENT_RELEASE.searchIntentVersion, 'score-school-search-v3963_0');
...
for (const marker of [
  ...
  'app.v3963_0.js?v=3963_0',
  'mode-switch.v3963_0.css?v=3963_0',
  'selection-workspace.v3963_0.css?v=3963_0',
...
for (const file of ['ln-rank/active-assets.json', 'ln-rank/release-meta.json']) {
  ...
  assert.equal(meta.searchIntentVersion, 'score-school-search-v3963_0');
  ...
  assert.ok(meta.jsEntry.includes('js/workspace/selection-workspace-orchestrator.v3963_0.js'));
...
try {
  ...
  console.log(JSON.stringify({
    ok: true,
    contract: 'dual-search-intent-v3963_0',
