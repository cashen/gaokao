...
assert(index.includes('ln-v3-alpha1-fix1'), 'index body class missing fix1');
assert(debug.includes('ln-v3-alpha1-fix1'), 'debug body class missing fix1');
assert(version.includes("name: 'V3.0.0.alpha1.fix1｜访问码跳转与Debug路由修正版'"), 'version name missing fix1');
assert(version.includes('v300alpha1fix1-20260512'), 'version stamp missing fix1');
...
console.log('All V3.0.0.alpha1.fix1 checks passed.');
