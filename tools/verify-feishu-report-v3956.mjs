...
const record = {
  ...
  statusLabel: '稍高目标', position: '稍高目标区', matchLabel: '相关方向', matchReason: '专业名称符合当前方向',
...
assert.equal(reportData.sourceMode, 'current-visible-band');
...
console.log('FEISHU_REPORT_V3956_OK');
