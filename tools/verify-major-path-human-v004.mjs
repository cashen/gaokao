...
const human = read('major-path/app.v004.js');
const core = read('major-path/app.v002.js');
const humanCss = read('major-path/major-path-human.v004.css');
...
assert.match(index, /\/major-path\/app\.v004\.js\?v=004_0/);
assert.match(index, /\/major-path\/major-path-human\.v004\.css\?v=004_0/);
...
assert.match(human, /cancelLegacyViewport/);
assert.match(human, /suppressLegacyScroll/);
...
console.log(JSON.stringify({
  ok: true,
  version: 'major-path-human-source-v0.04',
  visibleProduct: 'major-path-v0.04',
  preservedCore: 'major-path-v0.02',
