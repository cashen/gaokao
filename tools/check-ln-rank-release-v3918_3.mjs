...
const must = [
  ...
  'ln-rank/js/app.v3918_3.js',
  'ln-rank/js/selection-pool.v3918_3.js',
  'ln-rank/js/self-check.v3918_3.js',
  'ln-rank/js/major-trend-render.v3918_3.js',
...
if (!index.includes('app.v3918_3.js')) errors.push('首页入口版本未更新');
...
console.log('ln-rank v3.9.18.3 release check passed');
