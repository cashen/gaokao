...
if(manifest.version!=='simulation-workspace-v014.2')throw new Error('manifest version mismatch');
if(manifest.revision!=='r064-browser-diagnostics')throw new Error('manifest revision mismatch');
if(manifest.noFabrication!==true)throw new Error('noFabrication must be true');
console.log('simulation-report-v014.2-school-major-intent contract: PASS');
