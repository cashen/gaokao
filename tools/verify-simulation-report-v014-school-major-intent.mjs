...
if(manifest.version!=='simulation-workspace-v014.7')throw new Error('manifest version mismatch');
if(manifest.revision!=='r069-current-workbench-regression-cleanup')throw new Error('manifest revision mismatch');
if(manifest.noFabrication!==true)throw new Error('noFabrication must be true');
console.log('simulation-report-v014.7-school-major-intent contract: PASS');
