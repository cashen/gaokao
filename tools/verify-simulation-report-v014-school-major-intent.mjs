...
if(manifest.version!=='simulation-workspace-v014.5')throw new Error('manifest version mismatch');
if(manifest.revision!=='r067-human-typing-browser-regression')throw new Error('manifest revision mismatch');
if(manifest.noFabrication!==true)throw new Error('noFabrication must be true');
console.log('simulation-report-v014.5-school-major-intent contract: PASS');
