...
import './verify-major-bands-rank-native-scan-v3990_3.mjs';
import './verify-major-bands-predecode-region-v3990_3.mjs';
import './verify-major-bands-refinement-projection-v3990_3.mjs';
import './verify-major-bands-platform-upgrade-v3990_3.mjs';
...
} from '../functions/_lib/major-bands-rank-index.v3990_3.js';
...
} from '../functions/_lib/major-bands-rank-bucket-loader.v3990_3.js';
import {
  majorBandsSnapshotId,
  paginateMajorBandsRecords
} from '../functions/_lib/major-bands-result-order.v3990_3.js';
import {
...
const summary = {
  version: 'major-bands-full-recall-audit-v3990_3',
...
for (const required of [
  "MAJOR_BANDS_RANK_ROW_FILTER_VERSION = 'major-bands-rank-row-filter-v3990_3'",
  ...
  "MAJOR_BANDS_PAGE_ID_ID_FIRST_PREFILTER_VERSION = 'major-bands-page-id-id-first-prefilter-v3990_3'",
...
const bucketLoaderSource = fs.readFileSync('functions/_lib/major-bands-rank-bucket-loader.v3990_3.js', 'utf8');
for (const required of [
...
const queryKernelSource = fs.readFileSync('functions/_lib/major-bands-rank-query-kernel.v3990_3.js', 'utf8');
for (const required of [
  "MAJOR_BANDS_RANK_QUERY_MEMORY_MODE = 'requested-band-lightweight-order-current-page-v3990_3'",
...
for (const required of [
  "MAJOR_BANDS_REQUESTED_BAND_ORDER_CACHE_VERSION = 'major-bands-requested-band-order-id-lru-v3990_3'",
  ...
  "MAJOR_BANDS_ORDER_PAGE_SOURCE_VERSION = 'major-bands-order-page-raw-row-reuse-v3990_3'",
...
for (const required of [
  ...
  'candidateLimit: null',
  'stable-full-id-snapshot-v3990_3',
  's-maxage=60'
]) {
...
const evidencePath = process.env.MAJOR_BANDS_RANK_AUDIT_EVIDENCE || '/tmp/major-bands-rank-kernel-v3990_3.json';
