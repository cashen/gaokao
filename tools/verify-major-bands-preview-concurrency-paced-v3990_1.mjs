...
const sourcePath = new URL('./verify-major-bands-preview-concurrency-v3990_1.mjs', import.meta.url);
const generatedPath = new URL('./.verify-major-bands-preview-concurrency-paced-v3990_1.generated.mjs', import.meta.url);
