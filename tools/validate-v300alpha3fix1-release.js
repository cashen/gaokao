...
assert(index.includes('ln-v3-alpha3-fix1'), 'index body class missing alpha3');
assert(debug.includes('ln-v3-alpha3-fix1'), 'debug body class missing alpha3');
assert(version.includes("V3.0.0.alpha3.fix1｜Debug数据水合与Step2自测校准版"), 'version name missing alpha3');
assert(version.includes('v300alpha3fix1-20260512'), 'version stamp missing alpha3');
...
assert(store.includes('v3-alpha3fix1-family-bottomline-preview'), 'compute lastReason alpha3 missing');
...
console.log('All V3.0.0.alpha3.fix1 checks passed.');
