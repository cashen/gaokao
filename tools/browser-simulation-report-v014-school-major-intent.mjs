...
async function run(viewport,label){
  ...
  await page.route('**/api/ai/major-history**',async route=>{
    ...
    const rows=[
      {id:'m-1',school:'辽宁科技大学',major:'机械设计制造及其自动化',standardMajorName:'机械设计制造及其自动化',majorCode2026:'080202',standardMajorCode:'080202'},
      {id:'m-2',school:'辽宁科技大学',major:'机械电子工程',standardMajorName:'机械电子工程',majorCode2026:'080204',standardMajorCode:'080204'},
      {id:'m-3',school:'辽宁科技大学',major:'测控技术与仪器',standardMajorName:'测控技术与仪器',majorCode2026:'080301',standardMajorCode:'080301'},
      {id:'m-4',school:'辽宁科技大学',major:'网络工程',standardMajorName:'网络工程',majorCode2026:'080903',standardMajorCode:'080903'},
      {id:'m-5',school:'辽宁科技大学',major:'计算机科学与技术',standardMajorName:'计算机科学与技术',majorCode2026:'080901',standardMajorCode:'080901'}
    ];
    let records=[];
    if(school==='辽宁科技大学'){
  ...
  await typeMajor(currentMajor,'网络');
  await page.waitForSelector('[data-v014-major-box] .major-suggestion strong',{timeout:30000});
  ...
  await typeMajor(currentMajor,'计算机');
  await page.waitForSelector('[data-v014-major-box] .major-suggestion strong',{timeout:30000});
  ...
  await typeMajor(currentMajor,'测空技术与仪器');
