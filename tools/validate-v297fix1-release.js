...
const required = [
  'index.html',
  'diagnostics.html',
  'assets/app.v297fix1.css',
  'assets/app.v297fix1.js',
  'assets/theme-tokens.v297fix1.js',
  'assets/qualification-gate-ui.v297fix1.js'
];
...
if (!index.includes('V2.9.7.fix1')) {
  console.error('index.html version marker missing');
  process.exit(1);
}
if (!index.includes('app.v297fix1.css')) {
  console.error('index.html css reference not upgraded');
  process.exit(1);
}
console.log('V2.9.7.fix1 validation passed');
