...
assert.equal(CURRENT_RELEASE.resourceOwners.siteRuntimeContract, '/shared/resources/release/site-runtime-contract.v3990_3.js');

const html = read('aiplus/index.html');
const app = read('aiplus/app.v3990_3.js');
const htmlRuntime = html.match(/<script[^>]+src="([^"]*app\.v3990_3\.js[^"]*)"/)?.[1] || '';
...
assert.ok(deployWorkflow.includes('s/v3990_0/v3990_3/g'), 'Cloudflare verifier generation mapping changed without architecture migration');
...
console.log(JSON.stringify({
  ok: true,
  version: 'architecture-handoff-v3990_3',
