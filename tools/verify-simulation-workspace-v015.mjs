...
assert.match(html,/simulation-report-v015-human-workbench\.js\?v=v015\.8-r082/);
...
assert.equal(manifest.version,'simulation-workspace-v015.8');
assert.equal(manifest.revision,'r082-regression-matrix');
...
console.log('simulation-workspace-v015.8 contract: PASS');
