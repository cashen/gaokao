...
assert.match(html,/simulation-report-v015-human-workbench\.js\?v=v015\.3-r077/);
...
assert.equal(manifest.version,'simulation-workspace-v015.3');
assert.equal(manifest.revision,'r077-query-cache-and-school-rebind');
...
console.log('simulation-workspace-v015.3 contract: PASS');
