...
assert.match(html,/simulation-report-v015-human-workbench\.js\?v=v015\.4-r078/);
...
assert.equal(manifest.version,'simulation-workspace-v015.4');
assert.equal(manifest.revision,'r078-ime-dependency-and-polling-fix');
...
console.log('simulation-workspace-v015.4 contract: PASS');
