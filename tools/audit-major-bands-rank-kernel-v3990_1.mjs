...
} from '../functions/_lib/major-bands-rank-bucket-loader.v3990_1.js';
import {
  majorBandsSnapshotId,
  paginateMajorBandsRecords
} from '../functions/_lib/major-bands-result-order.v3990_1.js';
import {
...
const summary = {
  version: 'major-bands-full-recall-audit-v3990_1',
...
const queryKernelSource = fs.readFileSync('functions/_lib/major-bands-rank-query-kernel.v3990_1.js', 'utf8');
for (const required of [
  "MAJOR_BANDS_RANK_QUERY_MEMORY_MODE = 'requested-band-lightweight-order-current-page-v3990_1'",
...
for (const required of [
  "MAJOR_BANDS_REQUESTED_BAND_ORDER_CACHE_VERSION = 'major-bands-requested-band-order-id-lru-v3990_1'",
  ...
  "MAJOR_BANDS_ORDER_PAGE_SOURCE_VERSION = 'major-bands-order-page-raw-row-reuse-v3990_1'",
...
for (const required of [
  ...
  'candidateLimit: null',
  'stable-full-id-snapshot-v3990_1',
  's-maxage=60'
]) {
...
const evidencePath = process.env.MAJOR_BANDS_RANK_AUDIT_EVIDENCE || '/tmp/major-bands-rank-kernel-v3990_1.json';
