...
assert.match(handoff, /看看学校整体的学习和生活体验/);
...
assert.match(html, /app\.v3990_3\.js\?v=3990_3-nav003&r=r046-ln-rank-dynamic-focus-scroll/);
...
console.log(JSON.stringify({ok:true,entries:['专业升学路径','跨校学生留言','学生谈这所学校'],pcHiddenEntries:false,cacheRevision:'r042-direct-min-score-handoff'},null,2));
