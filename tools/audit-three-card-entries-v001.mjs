...
assert.match(handoff, /major-path-handoff\.v003\.css\?v=003_0&r=r034-worker-1102-bounded-api/);
assert.match(html, /app\.v3990_2\.js\?v=3990_2-nav003&r=r034-worker-1102-bounded-api/);
assert.match(html, /ln-rank-workspace\.v3967_0\.css\?v=3967_0&r=r034-worker-1102-bounded-api/);
assert.match(commit, /family-card-presenter\.v3967_0\.js\?v=3967_0&r=r034-worker-1102-bounded-api/);
...
console.log(JSON.stringify({ok:true,entries:['专业升学路径','大学生说专业','大学生说学校'],pcHiddenEntries:false,cacheRevision:'r034-worker-1102-bounded-api'},null,2));
