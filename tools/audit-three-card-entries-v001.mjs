...
assert.match(html, /app\.v3990_3\.js\?v=3990_3-nav003&r=r044-ln-rank-navigation-focus-query/);
...
console.log(JSON.stringify({ok:true,entries:['专业升学路径','大学生说专业','大学生说学校'],pcHiddenEntries:false,cacheRevision:'r042-direct-min-score-handoff'},null,2));
