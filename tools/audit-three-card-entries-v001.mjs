...
assert.match(html, /ln-rank-workspace\.v3967_0\.css\?v=3967_0&r=r027-card5/);
assert.match(commit, /family-card-presenter\.v3967_0\.js\?v=3967_0&r=r027-card5/);
...
console.log(JSON.stringify({ok:true,entries:['专业升学路径','大学生说专业','大学生说学校'],pcHiddenEntries:false,cacheRevision:'r027-card5'},null,2));
