...
for (const p of [
  ...
  'ln-rank/js/app.v3987.js','ln-rank/js/selection-pool.v3987.js','ln-rank/js/self-check.v3987.js',
  'ln-rank/js/keyword-token-classifier.v3987.js','ln-rank/js/review-point-builder.v3987.js',
...
console.log('check-ln-rank-release-v3987 ok');
