...
const siteRuntime = read('shared/resources/release/site-runtime-contract.v3990_0.js');
...
assert(release.includes("display: 'v3.9.90.0'"), 'current public release display');
assert(release.includes("assetVersion: 'v3990_0'"), 'current site generation');
assert(release.includes("assetReleaseVersion: 'v3.9.90.0'"), 'current release lineage');
assert(release.includes("siteRuntimeGeneration: 'v3990_0'"), 'current site runtime generation');
