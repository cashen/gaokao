...
const siteRuntime = read('shared/resources/release/site-runtime-contract.v3990_1.js');
...
assert(release.includes("display: 'v3.9.90.1'"), 'current public release display');
assert(release.includes("assetVersion: 'v3990_1'"), 'current site generation');
assert(release.includes("assetReleaseVersion: 'v3.9.90.1'"), 'current release lineage');
assert(release.includes("siteRuntimeGeneration: 'v3990_1'"), 'current site runtime generation');
