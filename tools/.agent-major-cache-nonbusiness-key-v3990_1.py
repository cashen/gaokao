...
# Replace the explicit stress/deploy pair in all three cache-key builders.
...
# Strengthen production resource audit.
...
# Strengthen query-cache audit source (generated v3990.1 inherits it).
