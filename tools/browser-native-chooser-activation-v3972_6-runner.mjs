...
const sourcePath = new URL('./browser-native-chooser-activation-v3972_6.mjs', import.meta.url);
const generatedPath = new URL('./.browser-native-chooser-activation-v3972_6.generated.mjs', import.meta.url);
