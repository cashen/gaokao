...
const artifactDir = process.env.DUAL_SEARCH_ARTIFACT_DIR || '/tmp/dual-search-v3964_1';
...
try {
  for (const testCase of cases) {
    ...
    try {
      ...
      assert.equal(finalMetrics.release, 'v3.9.64.1');
...
console.log(JSON.stringify({
  ok: true,
  contract: 'dual-search-real-journey-v3964_1',
  cases: results
}, null, 2));
