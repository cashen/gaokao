...
ok(main.includes('app.v3959_0.js?v=3959_0'),'shared main wrapper loaded');
ok(!main.includes('app.v3951_0.js?v=3959_0'),'legacy main not loaded directly');
...
ok(!main.includes('family-decision-bar.v3955_0.js'),'legacy family bar not active');
...
ok(selection.includes('selection-pool.v3959_0.js?v=3959_0'),'selection v3959 entry');
...
ok(t('ln2026.html').includes('major-difficulty-2026.v3959_0.js?v=3959_0'),'difficulty UI adapter');
...
ok(root.includes('foundation.v3959_0.css?v=3959_0')&&root.includes('family-shell.v3959_0.js?v=3959_0'),'root shared UI shell');
...
ok(zyPage.includes('zy2026.v3959_0.js?v=3959_0')&&zyPage.includes('zy2026.v3954_0.css?v=3955_0'),'zy2026 v3959 UI wrapper loaded');
...
ok(t('zy2026/assets/zy2026.v3959_0.js').includes('shared/ui/shell/family-shell.v3959_0.js'),'zy shared UI adapter');
...
ok(t('ln-rank/js/major-difficulty-2026.v3959_0.js').includes('shared/ui/shell/family-shell.v3959_0.js'),'difficulty shared UI adapter');
...
const appWrapper=t('ln-rank/js/app.v3959_0.js');
...
ok(appWrapper.includes('shared/ui/shell/family-shell.v3959_0.js'),'main shared UI adapter');
...
ok(t('shared/ui/shell/family-shell.v3959_0.js').includes('当前家庭方案'),'shared family shell');
ok(t('tongxue/app/tongxue-performance-v156.js').includes('shared/ui/shell/family-shell.v3959_0.js'),'Tongxue shared UI adapter');
...
ok(active.mainJs==='js/app.v3959_0.js'&&active.jsEntry.includes('js/app.v3959_0.js'),'active shared main');
ok(active.selectionPoolJs==='js/selection-pool.v3959_0.js'&&active.jsEntry.includes('js/selection-pool.v3959_0.js'),'active selection');
...
ok(active.sharedUiOwnershipContract===true&&active.sharedUiSixPageAdapterContract===true,'shared UI active contracts');
...
ok(active.jsEntry.includes('../shared/ui/shell/family-shell.v3959_0.js'),'active shared family shell');
ok(!active.jsEntry.includes('js/ux/family-decision-bar.v3955_0.js'),'legacy family bar inactive');
ok(active.cssEntry.includes('../shared/ui/tokens/foundation.v3959_0.css'),'active shared UI css');
...
ok(release.sharedUiOwnershipContract===true&&release.sharedUiSixPageAdapterContract===true,'v3959 UI contracts');
...
console.log(`LN 2026 ${VERSION} resource and UI orchestration checks passed`);
