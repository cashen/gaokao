...
ok(main.includes('app.v3960_0.js?v=3960_0'),'v3960 main wrapper loaded');
ok(!main.includes('app.v3951_0.js?v=3960_0'),'legacy main not loaded directly');
ok(main.includes('foundation.v3959_0.css'),'shared UI tokens loaded');
ok(main.includes('family-shell.v3960_0.css?v=3960_0'),'v3960 UI shell loaded');
...
ok(selection.includes('selection-pool.v3960_0.js?v=3960_0'),'selection v3960 entry');
...
const appWrapper=t('ln-rank/js/app.v3960_0.js');
...
ok(appWrapper.includes('shared/ui/shell/family-shell.v3960_0.js'),'main v3960 UI adapter');
...
const uiRegistry=t('shared/ui/ui-registry.v3960_0.js');
...
ok(t('shared/ui/shell/family-shell.v3960_0.js').includes('当前家庭方案'),'shared family shell');
...
ok(active.mainJs==='js/app.v3960_0.js'&&active.jsEntry.includes('js/app.v3960_0.js'),'active v3960 main');
...
ok(active.jsEntry.includes('../shared/ui/shell/family-shell.v3960_0.js'),'active shared family shell');
ok(active.jsEntry.includes('../shared/algorithms/algorithm-registry.js'),'active algorithm registry');
ok(!active.jsEntry.includes('js/ux/family-decision-bar.v3955_0.js'),'legacy family bar inactive');
ok(active.cssEntry.includes('../shared/ui/tokens/foundation.v3959_0.css')&&active.cssEntry.includes('../shared/ui/shell/family-shell.v3960_0.css'),'active shared UI css');
...
ok(release.sharedUiOwnershipContract===true&&release.selectedReviewDistinctRouteContract===true,'v3960 UI contracts');
...
console.log(`LN 2026 ${VERSION} resource, UI and algorithm orchestration checks passed`);
