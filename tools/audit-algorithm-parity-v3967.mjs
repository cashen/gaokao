...
import { rankMajorBandsRecordsOnce, MAJOR_BANDS_RESULT_ORDER_VERSION } from '../functions/_lib/major-bands-result-order.v3990_0.js';
...
assert.match(majorBandsApi,/major-bands-result-order\.v3990_0/);
assert.match(majorBandsApi,/major-bands-rank-query-kernel\.v3990_0/);
assert.match(fs.readFileSync('functions/_lib/major-bands-result-order.v3990_0.js','utf8'),/staged-ranking\.v3960_0/);
