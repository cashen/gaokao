...
const human = read('major-path/app.v005.js');
...
assert.match(core, /major-path-core-v0\.05/);
...
console.log(JSON.stringify({
  ok: true,
  version: 'major-path-human-source-v0.05',
  visibleProduct: 'major-path-v0.05',
  activeCore: 'major-path-core-v0.05',
