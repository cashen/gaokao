...
assert(index.includes('ln-v3-alpha4-fix1'), 'index body class missing alpha4.fix1');
assert(debug.includes('ln-v3-alpha4-fix1'), 'debug body class missing alpha4.fix1');
assert(version.includes("V3.0.0.alpha4.fix1｜Step2继续跳转与页面滚动修正版"), 'version name missing alpha4.fix1');
assert(version.includes('v300alpha4fix1-20260512'), 'version stamp missing alpha4.fix1');
...
console.log('All V3.0.0.alpha4.fix1 checks passed.');
