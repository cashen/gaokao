...
const evidencePath = process.env.MAJOR_BANDS_CONCURRENCY_EVIDENCE || '/tmp/major-bands-concurrency-v3990_1.json';
const expectedQueryCacheVersion = 'major-bands-query-execution-cache-single-heavy-v3990_1';
const expectedAllBandsPageCacheVersion = 'major-bands-all-bands-page-cache-release-on-band-switch-v3990_1';
const expectedExecutionGateVersion = 'major-bands-query-execution-gate-v3990_1';
const expectedExecutionGateMode = 'request-owned-timer-polling';
const expectedBucketLoaderVersion = 'major-bands-rank-bucket-loader-bounded-all-band-v3990_1';
...
const expectedResultOrderVersion = 'major-bands-result-order-ephemeral-v3990_1';
const expectedRankingMemoryMode = 'ephemeral-compact-tuples-v3990_1';
const expectedAllBandsExecutionMode = 'sequential-internal-band-requests-v3990_1';
const expectedAllBandsSharedProjectionVersion = 'major-bands-all-bands-shared-projection-v3990_1';
...
function validateResult(result) {
  ...
  assert.equal(result.payload?.source?.queryKernelVersion, 'major-bands-rank-query-kernel-v3990_1', `${result.scenario}: query kernel`);
  ...
  assert.equal(result.payload?.source?.allBandsPageCacheReleaseMode, 'release-completed-on-requested-band-switch-v3990_1', `${result.scenario}: all-band page cache release mode`);
...
const evidence = {
  version: 'major-bands-real-concurrency-v3990_1',
  ...
  concurrencyContract: 'shared-and-distinct-query-identities-v3990_1',
