...
const generatedPath = new URL('./.audit-academic-background-v3990_3.generated.mjs', import.meta.url);
let source = fs.readFileSync(sourcePath, 'utf8');
source = source
  .replaceAll("../shared/governance/resource-execution-contract.v3969_0.js", "../shared/governance/resource-execution-contract.v3990_3.js")
  .replaceAll("'v3.9.69.0'", "'v3.9.90.3'")
  .replaceAll("'v3969_0'", "'v3990_3'")
  .replaceAll("'resource-execution-v3969_0'", "'resource-execution-v3990_3'");
