...
import { RESOURCE_EXECUTION_REGISTRY } from '../shared/governance/resource-execution-contract.v3990_1.js';
...
const runtime = read('ln-rank/js/ux/family-home.v3990_1.js');
...
assert.equal(CURRENT_RELEASE.homeEntryVersion, 'family-home-runtime-v3990_1');
assert.equal(CURRENT_RELEASE.resourceOwners.homeStructure, '/index.html');
assert.equal(CURRENT_RELEASE.resourceOwners.homeRuntime, '/ln-rank/js/ux/family-home.v3990_1.js');
assert.equal(CURRENT_RELEASE.resourceOwners.familyShell, '/shared/ui/shell/family-shell.v3990_1.js');
...
assert.equal(RESOURCE_EXECUTION_REGISTRY.home.owner, '/ln-rank/js/ux/family-home.v3990_1.js');
...
assert.equal(RESOURCE_EXECUTION_REGISTRY.home.schemaVersion, 'family-home-runtime-v3990_1');
assert.equal(LN_RANK_RUNTIME_CACHE_CONTRACT.entrypoints.homeRuntime, '/ln-rank/js/ux/family-home.v3990_1.js?v=3990_1');
assert.equal(LN_RANK_RUNTIME_CACHE_CONTRACT.owners.home, '/ln-rank/js/ux/family-home.v3990_1.js');
assert.ok(LN_RANK_RUNTIME_CACHE_CONTRACT.activeGenerationModules.includes('/ln-rank/js/ux/family-home.v3990_1.js'));
assert.ok(!LN_RANK_RUNTIME_CACHE_CONTRACT.declaredStableActiveModules.includes('/ln-rank/js/ux/family-home.v3990_1.js'));
...
for (const marker of [
  'release-presenter.v3990_1.js?v=3990_1',
  'family-shell.v3990_1.js?v=3990_1',
  'family-decision-contract.v3970_0.js?v=3970_0',
  "HOME_RUNTIME_VERSION = 'family-home-runtime-v3990_1'",
...
assert.equal(manifest.currentGenerationEntrypoints.home, '/ln-rank/js/ux/family-home.v3990_1.js?v=3990_1');
