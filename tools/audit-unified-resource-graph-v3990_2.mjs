...
} from '../shared/ui/ui-resource-registry.v3990_2.js';
import { ALGORITHM_RESOURCE_REGISTRY } from '../shared/algorithms/algorithm-registry.js';
import { RESOURCE_EXECUTION_REGISTRY } from '../shared/governance/resource-execution-contract.v3990_2.js';
...
const PAGINATION_SNAPSHOT_GUARD_PATH = '/ln-rank/js/feature/major-pool/pagination-snapshot-guard.v3990_2.js?v=3990_2';
...
assert.equal(CURRENT_RELEASE.resourceOwners.uiResourceRegistry, '/shared/ui/ui-resource-registry.v3990_2.js');
...
for (const item of UI_CSS_RESOURCE_GRAPH) {
  ...
  if (item.classification === 'current-generation') {
    assert.ok(item.path.includes('.v3990_2.'), `current CSS is not v3990_2: ${item.path}`);
  }
}
...
for (const marker of [
  "current-release.js?v=3990_2",
  "ui-resource-registry.v3990_2.js?v=3990_2",
