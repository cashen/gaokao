...
} from '../shared/ui/ui-resource-registry.v3990_1.js';
...
const PAGINATION_SNAPSHOT_GUARD_PATH = '/ln-rank/js/feature/major-pool/pagination-snapshot-guard.v3990_1.js?v=3990_1';
...
assert.equal(CURRENT_RELEASE.resourceOwners.uiResourceRegistry, '/shared/ui/ui-resource-registry.v3990_1.js');
...
for (const item of UI_CSS_RESOURCE_GRAPH) {
  ...
  if (item.classification === 'current-generation') {
    assert.ok(item.path.includes('.v3990_1.'), `current CSS is not v3990_1: ${item.path}`);
  }
}
...
for (const marker of [
  "current-release.js?v=3990_1",
  "ui-resource-registry.v3990_1.js?v=3990_1",
