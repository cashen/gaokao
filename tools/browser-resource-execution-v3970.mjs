...
const generatedPath = new URL('./.browser-resource-execution-v3972_5.generated.mjs', import.meta.url);
...
source = source
  ...
  .replaceAll("resource-execution-browser-v3967_0", "resource-execution-browser-v3972_5");
