...
includesAll(main, ['确认孩子的位置','说清想看什么','圈出并整理专业','家庭逐项复核','app.v3955_0.js?v=3955_0','family-decision-workspace.v3955_0.css','family-presentation.v3955_0.js','family-decision-bar.v3955_0.js','data-release="v3.9.55.0"'], 'main flow');
...
includesAll(selection, ['检查已选专业','看看当前方案有没有明显偏科','生成家庭复核报告','其他保存方式','data-release="v3.9.55.0"'], 'selection page');
