...
const sharedShell = read('shared/ui/shell/family-shell.v3959_0.js');
...
includesAll(main, ['确认孩子的位置','说清想看什么','圈出并整理专业','家庭逐项复核','app.v3959_0.js?v=3959_0','family-decision-workspace.v3955_0.css','family-presentation.v3955_0.js',`data-release="${CURRENT_RELEASE.display}"`], 'main flow');
...
includesAll(selection, ['检查已选专业','看看当前方案有没有明显偏科','生成家庭复核报告','其他保存方式','selection-pool.v3959_0.js?v=3959_0',`data-release="${CURRENT_RELEASE.display}"`], 'selection page');
...
includesAll(sharedShell, ['当前家庭方案','data-ui-mobile-selected','data-ui-mobile-pending','lnrank-selection-pool-updated','resolveFamilyNextAction'], 'shared family shell');
...
assert.ok(active.jsEntry.includes('js/app.v3959_0.js'));
assert.ok(active.jsEntry.includes('js/ux/family-presentation.v3955_0.js'));
assert.ok(active.jsEntry.includes('../shared/ui/shell/family-shell.v3959_0.js'));
...
console.log('FAMILY_DECISION_V3959_OK');
