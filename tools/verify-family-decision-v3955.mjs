...
includesAll(main, ['确认孩子的位置','说清想看什么','圈出并整理专业','家庭逐项复核','app.v3958_0.js?v=3958_0','family-decision-workspace.v3955_0.css','family-presentation.v3955_0.js','family-decision-bar.v3955_0.js',`data-release="${CURRENT_RELEASE.display}"`], 'main flow');
...
includesAll(selection, ['检查已选专业','看看当前方案有没有明显偏科','生成家庭复核报告','其他保存方式',`data-release="${CURRENT_RELEASE.display}"`], 'selection page');
...
for (const key of [
  ...
  'unifiedResourceOwnershipContract','sharedSchoolIdentityOwnerContract'
]) {
...
assert.ok(active.jsEntry.includes('js/app.v3958_0.js'));
...
console.log('FAMILY_DECISION_V3958_OK');
