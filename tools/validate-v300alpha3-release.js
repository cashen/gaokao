...
assert(index.includes('ln-v3-alpha3'), 'index body class missing alpha3');
assert(debug.includes('ln-v3-alpha3'), 'debug body class missing alpha3');
assert(version.includes("V3.0.0.alpha3｜Step2家庭底线与辽宁Hard预览版"), 'version name missing alpha3');
assert(version.includes('v300alpha3-20260512'), 'version stamp missing alpha3');
...
assert(store.includes('v3-alpha3-family-bottomline-preview'), 'compute lastReason alpha3 missing');
...
console.log('All V3.0.0.alpha3 checks passed.');
