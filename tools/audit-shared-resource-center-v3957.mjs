...
assert.ok(mainPage.includes('/ln-rank/css/school-all-mode.v3962_1.css?v=3962_0'));
...
assert.ok(appWrapper.includes("await import('./feature/school-majors/school-all-mode.v3962_1.js?v=3962_0')"));
