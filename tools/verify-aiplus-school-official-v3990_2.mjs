...
import {
  AI_SCHOOL_OFFICIAL_ORIGIN,AI_SCHOOL_OFFICIAL_SOURCE_VERSION,schoolOfficialTopic,schoolOfficialTopicLabel,
  htmlToOfficialPlainText,extractOfficialSchoolSearchMatch,extractOfficialSchoolNavigation,extractLatestCharterLink,loadOfficialSchoolEvidence
...
console.log(JSON.stringify({ok:true,version:AI_SCHOOL_OFFICIAL_SOURCE_VERSION,schoolMatch:searchMatch,topic:evidence.topic,task:'school_official_qa',officialOrigin:AI_SCHOOL_OFFICIAL_ORIGIN},null,2));
