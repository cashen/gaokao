...
if(!index.includes('app.v2945.js')) throw new Error('index.html does not load app.v2945.js');
if(!index.includes('app.v2945.css')) throw new Error('index.html does not load app.v2945.css');

const app = fs.readFileSync(path.join(root,'assets/app.v2945.js'),'utf8');
