...
const must = [
  ...
  'assets/config.v2953fix5.js','assets/rules.v2953fix5.js','assets/data-engine.v2953fix5.js','assets/filter-engine.v2953fix5.js','assets/plan-engine.v2953fix5.js','assets/render.v2953fix5.js','assets/selection.v2953fix5.js','assets/export.v2953fix5.js','assets/app.v2953fix5.js','assets/app.v2953fix5.css',
...
for(const f of ['config.v2953fix5.js','rules.v2953fix5.js','data-engine.v2953fix5.js','filter-engine.v2953fix5.js','plan-engine.v2953fix5.js','render.v2953fix5.js','selection.v2953fix5.js','export.v2953fix5.js','app.v2953fix5.js','app.v2953fix5.css']){
...
const plan = read('assets/plan-engine.v2953fix5.js');
assert(!/PLAN_MODES_V2950/.test(plan) || /const\s+PLAN_MODES_V2950\s*=/.test(plan), 'PLAN_MODES_V2950 referenced but not defined');
const app = read('assets/app.v2953fix5.js');
assert(!/const\s+debouncedAutoRefresh/.test(app), 'app must not declare const debouncedAutoRefresh');
assert(/window\.debouncedAutoRefreshV2953Fix5/.test(app), 'app missing cache-safe debounced function');
assert(/function\s+unlockAccess/.test(app), 'app missing unlockAccess');
assert(/startV2953Fix5/.test(app), 'app missing fix5 start');
const diag = read('diagnostics.html');
assert(diag.includes('config.v2953fix5.js') && diag.includes('render.v2953fix5.js'), 'diagnostics does not load fix5 modules');
...
ctx.window = ctx;
const runtimeFiles = ['config.v2953fix5.js','rules.v2953fix5.js','major-name-model.v2946.js','confusable-major-model.v29462.js','data-engine.v2953fix5.js','filter-engine.v2953fix5.js','plan-engine.v2953fix5.js','render.v2953fix5.js','selection.v2953fix5.js','export.v2953fix5.js'];
...
console.log('V2.9.5.3.fix5 release validation passed');
