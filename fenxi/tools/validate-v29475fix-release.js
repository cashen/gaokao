...
const currentJs=html.includes('app.v29475fix3.js')?'assets/app.v29475fix3.js':(html.includes('app.v29475fix2.js')?'assets/app.v29475fix2.js':'assets/app.v29475fix.js');
const currentCss=html.includes('app.v29475fix3.css')?'assets/app.v29475fix3.css':(html.includes('app.v29475fix2.css')?'assets/app.v29475fix2.css':'assets/app.v29475fix.css');
const js=read(currentJs);
const css=read(currentCss);
ok(html.includes(currentCss),'index.html 引用当前 fix CSS');
ok(html.includes(currentJs),'index.html 引用当前 fix JS');
ok(html.includes('V2.9.4.7.5.fix'),'入口标题包含 V2.9.4.7.5.fix');
ok(js.includes('V2.9.4.7.5.fix'),'JS 版本号包含 fix');
