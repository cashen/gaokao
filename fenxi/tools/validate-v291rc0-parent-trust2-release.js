...
const activeFiles=[
 ...
 'assets/parent-trust.v291rc0parenttrust2.js',
 'assets/parent-trust.v291rc0parenttrust2.css'
].filter(exists);
...
check('孩子情况口径',all.includes('孩子情况'));
check('我家情况口径',all.includes('我家情况'));
check('当前优先考虑口径',all.includes('当前优先考虑'));
check('只看真正对口口径',all.includes('只看真正对口'));
