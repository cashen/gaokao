...
const activeJs = index.includes('assets/app.v29476.js') ? 'assets/app.v29476.js' : (index.includes('assets/app.v29475fix3.js') ? 'assets/app.v29475fix3.js' : (index.includes('assets/app.v29475fix2.js') ? 'assets/app.v29475fix2.js' : (index.includes('assets/app.v29475fix.js') ? 'assets/app.v29475fix.js' : (index.includes('assets/app.v29475.js') ? 'assets/app.v29475.js' : (index.includes('assets/app.v29474.js') ? 'assets/app.v29474.js' : (index.includes('assets/app.v29473.js') ? 'assets/app.v29473.js' : 'assets/app.v29472.js'))))));
const activeCss = index.includes('assets/app.v29476.css') ? 'assets/app.v29476.css' : (index.includes('assets/app.v29475fix3.css') ? 'assets/app.v29475fix3.css' : (index.includes('assets/app.v29475fix2.css') ? 'assets/app.v29475fix2.css' : (index.includes('assets/app.v29475fix.css') ? 'assets/app.v29475fix.css' : (index.includes('assets/app.v29475.css') ? 'assets/app.v29475.css' : (index.includes('assets/app.v29474.css') ? 'assets/app.v29474.css' : (index.includes('assets/app.v29473.css') ? 'assets/app.v29473.css' : 'assets/app.v29472.css'))))));
