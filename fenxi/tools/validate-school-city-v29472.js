...
const activeJs = index.includes('assets/app.v29474.js') ? 'assets/app.v29474.js' : (index.includes('assets/app.v29473.js') ? 'assets/app.v29473.js' : 'assets/app.v29472.js');
const activeCss = index.includes('assets/app.v29474.css') ? 'assets/app.v29474.css' : (index.includes('assets/app.v29473.css') ? 'assets/app.v29473.css' : 'assets/app.v29472.css');
