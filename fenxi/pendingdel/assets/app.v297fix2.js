...
setTimeout(()=>{try{initSimpleModeV2950();renderBaselineSummaryV2950();window.LN_QUALIFICATION_GATE_UI_V296?.renderSummary?.();}catch(e){console.warn('[V2.9.7] 简洁模式初始化失败',e)}},0);
