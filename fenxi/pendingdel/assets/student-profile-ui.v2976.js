// V2.9.7.6 student profile UI: light entry + drawer.
(function(){
  function rules(){return window.LN_STUDENT_PROFILE_RULES_V2976;}
  ...
  const api={renderSummary,openDrawer,ready:true}; window.LN_STUDENT_PROFILE_UI_V2976=api; window.LN_STUDENT_PROFILE_UI_V2975=api;
})();
