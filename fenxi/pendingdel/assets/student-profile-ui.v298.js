// V2.9.8 student profile UI: light entry + drawer.
(function(){
  ...
  const api={renderSummary,openDrawer,ready:true}; window.LN_STUDENT_PROFILE_UI_V298=api; window.LN_STUDENT_PROFILE_UI_V2975=api;
})();
