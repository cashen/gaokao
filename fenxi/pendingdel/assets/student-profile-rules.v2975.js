// V2.9.7.5 student profile rules: profile only changes explanation priority, never hard filters.
(function(){
  const STORAGE_KEY='ln_student_profile_state_v2975';
  ...
  window.LN_STUDENT_PROFILE_RULES_V2975={OPTIONS, optionLabel, safe, readState, saveState, deriveProfile, summary, ready:true};
})();
