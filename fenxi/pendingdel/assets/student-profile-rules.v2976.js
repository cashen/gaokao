// V2.9.7.6 student profile rules: profile only changes explanation priority, never hard filters.
(function(){
  const STORAGE_KEY='ln_student_profile_state_v2976';
  ...
  const api={OPTIONS, optionLabel, safe, readState, saveState, deriveProfile, summary, ready:true}; window.LN_STUDENT_PROFILE_RULES_V2976=api; window.LN_STUDENT_PROFILE_RULES_V2975=api;
})();
