...
function renderParentInterestPanelV2945(r){
  ...
  return `<div class="parent-insight-v2945">
    <div class="pi-head">
      <div><b>家长关心点</b><span>把专业名、位次、成本和候选建议翻译成人话</span></div>
...
function renderConfusableMajorPanelV2946(r){
  ...
  return `<details class="confusable-v2946" open>
    <summary><span>${riskLabelV2946(p.risk_level)}</span><b>名字相近，方向可能不同</b><em>${escapeV2946(p.group_name||'易混专业')}</em></summary>
...
function renderDebugPanel(){
  ...
  易混模型：<code>${CONFUSABLE_MODEL_2946?((CONFUSABLE_MODEL_2946.detectedPairs?.count||0)+' 对 / '+(CONFUSABLE_MODEL_2946.recordIndex?.count||0)+' 条索引'):'未加载'}</code><br/>app.js：<code>app.v2946.js</code>｜app.css：<code>app.v2946.css</code>`;
}
function initV292UX(){
