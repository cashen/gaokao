...
// V2.92RC｜详细卡片懒加载：专业学科/易混/取舍/规则按需生成
(function(){
  if(window.LN_DETAIL_LAZY_DISABLE===true) return;
  var VERSION='v292rc-detail-lazy';
  ...
  patchOnce();
  window.__LN_DETAIL_LAZY_STATE__={ready:true,version:VERSION,stamp:STAMP,expandedCount:0,lastExpandMs:0,storeSize:function(){return store.size;}};
  try{window.LN_DEBUG_V2983&&window.LN_DEBUG_V2983.setFlags&&window.LN_DEBUG_V2983.setFlags({detailLazy:true,taxonomyLazy:true,detailLazyVersion:VERSION});}catch(e){}
})();
