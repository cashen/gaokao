// V2.9.5.4 fix2 config: paths, shared state, runtime rule helpers and compatibility constants
...
const APP_VERSION_V29472 = 'V2.9.5.4.fix2｜规则中心落地与场景保护修正版';
...
window.LN_CONFIG = {
  version: 'V2.9.5.4.fix2｜规则中心落地与场景保护修正版',
