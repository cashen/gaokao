// V2.9.8.1 render-engine: detail candidate decision tags + legacy card rendering
...
function renderCards(){
  ...
  el.innerHTML=rows.map(r=>{
    ...
    const pathCard=window.LN_PATH_EXPLAIN_ENGINE_V2975?.cardHtml?.(r)||'';
    const pathDetail=window.LN_PATH_EXPLAIN_ENGINE_V2975?.detailHtml?.(r)||'';
    const decisionIntro=window.LN_DETAIL_CARD_UI_V2981?.cardIntroHtml?.(r)||'';
