/*
 * V2.92RC.engine-cleanup｜JS 引用与职责地图
 * 只登记工程结构，不改变业务计算。后续新增 JS 必须先归层再引用。
 */
(function(){
  'use strict';
  const VERSION='V2.92RC.engine-cleanup';
  const STAMP='292rc-engine-cleanup-20260521';
  const map={
    version:VERSION,
    stamp:STAMP,
    ...
    layers:[
      ...
      {id:'interaction',name:'交互稳定层',kind:'technical',files:['assets/app.v2983.js','assets/interaction-stability.v2982.js','assets/interact-stability.v29rc1.js','assets/interact-dedupe.v29rc2.js','assets/refresh-scheduler.v297fix2.js'],rule:'短期保留防抖/去重思想；后续统一收口到 refresh-controller。'},
      {id:'registry-debug',name:'工程闭环审计层',kind:'diagnostic',files:['assets/ln-runtime-registry.v292rc.js','assets/ln-state-adapter.v292rc.js','assets/ln-refresh-controller.v292rc.js','assets/ln-debug-baseline.v292rc.js'],rule:'只记录、审计、输出日志，不改变业务结果。'}
    ],
    ...
    finalExpectedOwners:{
      applyFilters:'compute-pipeline.v2983.js + app/interact wrappers',
