...
exportFiltered = function(){download('辽宁物理类_V2.9.6_筛选结果_控制区收纳版.csv',rowsToCsv(filtered));};
exportCandidates = function(){download('辽宁物理类_V2.9.6_候选清单_控制区收纳版.csv',rowsToCsv(candidates));};
