// V2.9.8.3.fix3 runtime debug collector: stores diagnostics and deep performance details in localStorage for /fenxi/debug.html.
(function(){
  const KEY='ln_v2983_debug_report';
  const state={version:'V2.9.8.3.fix3',stamp:'2983fix3-20260511',actions:[],timings:{},details:{},queue:{},errors:[],longTasks:[],pools:{},context:{},flags:{},lastAction:''};
  ...
  window.LN_DEBUG_V2983={state,log,timing,setPools,setContext,setFlags,detail,setQueue,report,textReport,save,ready:true,version:'V2.9.8.3.fix3'};
  save();
})();
