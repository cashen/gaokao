// V2.9.8.3.fix11 runtime debug collector: stores diagnostics and deep performance details in localStorage for /fenxi/debug.html.
(function(){
  const KEY='ln_v2983_debug_report';
  const state={version:(window.__LN_TOOL_VERSION||'V2.9.8.3.fix11'),stamp:(window.__LN_TOOL_STAMP||'2983fix11-20260511'),actions:[],timings:{},details:{},queue:{},errors:[],longTasks:[],pools:{},context:{},flags:{},lastAction:''};
  ...
  window.LN_DEBUG_V2983={state,log,timing,setPools,setContext,setFlags,detail,setQueue,report,textReport,save,ready:true,version:(window.__LN_TOOL_VERSION||'V2.9.8.3.fix11')};
  save();
})();
