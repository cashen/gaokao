...
(function(){
  const scenarioPresets = {
    platformSprint: {
      id:'platformSprint', order:10, group:'highScore', title:'高分平台冲刺｜冲刺上限',
    ...
    platformStable: {
      ...
      warning:'平台优先要同时看专业落点，不建议只看最低录取位次。', applyMode:'suggestOnly'
    },
    highValue: {
    ...
    employment: {
      ...
      warning:'稳就业不等于只看热门专业，仍需复核孩子是否学得动。', applyMode:'suggestOnly'
    },
    publicLow: {
      ...
      warning:'低分保公办不等于无脑选公办，专业可读性必须复核。', applyMode:'suggestOnly'
    },
    privateMajor: {
      ...
      warning:'民办不是不能选，但必须算清四年成本、专业质量和未来路径。', applyMode:'suggestOnly'
    },
    edgeBachelor: {
    ...
    budgetFlexible: {
      ...
      warning:'中外合作和民办不是天然提档，必须看钱换来了什么。', applyMode:'suggestOnly'
    },
    grid: {
      ...
      warning:'电网方向必须复核专业代码、学校行业背景和招聘口径。', applyMode:'suggestOnly'
    },
    medical: {
      ...
      warning:'带“医学”不等于医生路径，必须复核执业资格和培养方案。', applyMode:'suggestOnly'
    },
    exam: {
  ...
  const pathRules = {
    ...
    electric:{label:'电气 / 能源路径',core:['电气工程及其自动化','智能电网信息工程'],related:['自动化','能源与动力工程','新能源科学与工程'],fuzzy:['测控技术与仪器','电子信息工程','机械电子工程'],warnings:['自动化、测控、电子信息不能直接等同电气正主。'],review:['专业代码','学校行业背景','电网招聘口径','就业质量报告']},
    ...
    medical:{label:'医学 / 医学技术路径',core:['临床医学','口腔医学','麻醉学','医学影像学'],related:['医学检验技术','医学影像技术','药学','护理学','康复治疗学'],fuzzy:['生物医学工程'],warnings:['医学技术不等于临床医生路径。'],review:['执业资格','学制/规培','培养方案','是否医生路径']},
  ...
  const reviewRules = {
    highFee:{label:'高收费 / 中外合作',review:['学费','证书','培养地点','是否必须出国','转专业政策'],warning:'高收费/中外合作必须复核学费、证书、培养地点。'},
    specialPlan:{label:'高校专项',review:['专项资格','公示名单','招生计划'],warning:'高校专项计划不是普通考生通用入口。'},
