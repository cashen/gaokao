...
async function boot(){
  ...
  try{
    ...
    try{
      ...
      console.warn('[V2.9.6.fix3] 招生名/本科目录模型加载失败，不影响主筛选：', majorErr);
    }
    try{
...
setTimeout(()=>{try{initSimpleModeV2950();renderBaselineSummaryV2950();}catch(e){console.warn('[V2.9.6.fix3] 简洁模式初始化失败',e)}},0);
