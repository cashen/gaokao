// V2.91RC0.family-read1.frontfix4｜登录后首屏与步骤条净化版
(function(){
  var VERSION='v291rc0familyread1frontfix4';
  var STAMP='291rc0familyread1frontfix4-20260515';
  ...
  function debug(){try{window.LN_DEBUG_V2983?.setFlags?.({familyReadFrontFix:'v291rc0familyread1frontfix4',familyReadFrontFixStamp:STAMP,loginHeaderClean:true,stepNavLight:true,detailCardWarmUnified:true,doesModifyFormula:false,doesChangeCandidatePool:false,doesChangeSorting:false});}catch(e){} }
  function apply(){document.body.classList.add('family-read-frontfix4-v291rc0'); accessReady(); modeText(); debug();}
