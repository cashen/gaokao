...
function exportSummaryPng(kind='filtered'){
  ...
  topRows.forEach((r,i)=>{
    ...
    wrapCanvasText(ctx,`判断：${_judge||_cf.path||'—'}${_cf.tags?'｜'+_cf.tags:''}${_cf.conflicts?'｜冲突：'+_cf.conflicts:''}`,M+900,yy+92,contentW-980,23,'#6b7f93','19px sans-serif',2);
    yy += rowH;
  });
  y += listH + 24;
