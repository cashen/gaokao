...
(function(){
  ...
  const POLICY={
    ...
    bands:{
      top:{name:'高分顶段',maxRank:12000,aTooLow:-25,bTooLow:-18,cFantasy:55,bSafeMax:2,cNeedOpportunity:true},
      high:{name:'中高分段',maxRank:25000,aTooLow:-28,bTooLow:-22,cFantasy:45,bSafeMax:2,cNeedOpportunity:true},
      middle:{name:'中分取舍段',maxRank:60000,aTooLow:-36,bTooLow:-28,cFantasy:32,bSafeMax:3,cNeedOpportunity:true},
      low:{name:'低分避坑段',maxRank:90000,aTooLow:-48,bTooLow:-38,cFantasy:22,bSafeMax:4,cNeedOpportunity:true},
      edge:{name:'本科边缘段',maxRank:Infinity,aTooLow:-65,bTooLow:-48,cFantasy:18,bSafeMax:4,cNeedOpportunity:true},
      unknown:{name:'未定位',maxRank:Infinity,aTooLow:-40,bTooLow:-30,cFantasy:25,bSafeMax:3,cNeedOpportunity:false}
    },
    role:{
      A:'底线方案：安全、不坑、不失控，但不能无意义过低',
      B:'主线方案：专业/就业/家庭目标的最优平衡，不做第二个 A',
      C:'机会方案：必须有真实上探价值，不能把幻想包装成机会'
    },
    hardReject:{
      highFee:['高收费','民办','独立学院','中外合作'],
      site:['工地','现场','艰苦','设备'],
      medical:['夜班','长学制','长周期']
    },
    debug:{defaultMode:'full',perCaseTimeoutMs:16000,dataTimeoutMs:10000,computeTimeoutMs:3000,bucketTimeoutMs:1600}
  };
  window.LN_ABC_FORMULA_GOVERNANCE_V293RC1=POLICY;
})();
