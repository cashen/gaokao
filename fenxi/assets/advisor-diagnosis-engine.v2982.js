...
(function(){
  ...
  function fallbackFunnel(){try{return (typeof buildFunnelV29473==='function')?buildFunnelV29473():[];}catch(e){return [];}}
  ...
  function diagnose(){
    ...
    const funnel=fallbackFunnel(); const top=topPressure(funnel); const count=list.length; const conflicts=[];
    ...
    return {snapshot:Object.assign({},c,{provinces:c.family?.provinces||[],cities:c.family?.cities||[],budget:c.family?.budget,priority:c.priority,regionMode:c.family?.regionMode,cityMode:c.family?.cityMode}), funnel, top, conflicts:conflicts.slice(0,3)};
  }
