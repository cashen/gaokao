// V2.9.5.5 child interest rules: only defines rules, no DOM/data access.
(function(){
  const groups = [
    {
  ...
  window.LN_CHILD_INTEREST_RULES_V2955 = {
    version:'V2.9.5.5', schemaVersion:1, maxGroups:3, defaultMode:'undecided', reconfirmAfterDays:30,
    uiText:{
      title:'③ 孩子感兴趣的专业方向',
