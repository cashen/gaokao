// V2.9.6.fix4 qualification gate rules: special admissions entries are hidden until user confirms eligibility.
(function(){
  const gates=[
    {
  ...
  window.LN_QUALIFICATION_GATE_RULES_V296={version:'V2.9.6.fix4',gates,later,ready:true};
})();
