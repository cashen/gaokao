...
function applyFilters(){
  ...
  arr=arr.filter(r=>{
    ...
    if(window.LN_CHILD_INTEREST_RUNTIME_V2955 && !window.LN_CHILD_INTEREST_RUNTIME_V2955.filterPass(r))return false;
...
window.LN_FILTER_ENGINE = {
  ...
  specialPlanStatusV29474, specialPlanApprovedV29474, hasCollegeSpecialPlanV29474,
