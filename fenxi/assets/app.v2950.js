...
function deprecatedRenderPlanABC_V2950_2(){
...
function deprecatedRenderPlanABC_V2950_3(){
  const box=document.getElementById('planABC'); if(!box)return;
...
function deprecatedRenderPlanABC_V2950_4(){
  const box=document.getElementById('planABC'); if(!box)return;
