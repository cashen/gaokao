...
const APP_VERSION_V29472 = 'V2.9.4.7.5.fix3｜A/B/C 首选样式与备选小卡修正版';
...
/* V2.9.4.7.5.fix3: A/B/C 首选样式 + 备选小卡紧凑修正
...
exportFiltered = function(){download('辽宁物理类_V2.9.4.7.6_筛选结果_方案引擎.csv',rowsToCsv(filtered));};
exportCandidates = function(){download('辽宁物理类_V2.9.4.7.6_候选清单_方案来源.csv',rowsToCsv(candidates));};
