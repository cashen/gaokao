import { MAJOR_TREND_DATA, trendLabel, trendTone } from './feature/trend/index.js?v=3920_4';
...
export function mountMajorTrendPage() {
  ...
  function render() {
    ...
    root.innerHTML = `
      ...
      ${renderSegment(seg)}
      <section class="data-note">${escapeHtml(MAJOR_TREND_DATA.disclaimer)}<br>版本：v3.9.18.1｜数据口径：辽宁 2025 物理类｜热度口径：2024/2025 同校同专业普通项目</section>`;
