...
import { renderBandTabs } from './feature/score-bands/index.js';
...
const BOTTOMLINE_STORAGE_KEY = 'lnRank.bottomLineMode.v3912';
...
function rangePresetLabel(preset = state.rangePreset) {
  return ({ standard: '正常查看', wide: '多看一些', safe: '稳妥一点' })[preset] || '正常查看';
}
