...
async function main(){
 ...
 try{
  ...
  checks.push({name:'active-assets 版本',ok:assets.version==='v3.9.33.2'&&assets.assetVersion==='v3933_2',detail:`${assets.version} / ${assets.assetVersion}`});
  ...
  const activeJs=await fetchText('/ln-rank/js/app.v3933_2.js?v=3933_2') + '\n' + await fetchText('/ln-rank/js/selection-pool.v3933_2.js?v=3933_2');
