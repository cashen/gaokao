...
import { LN_RANK_RUNTIME_CACHE_CONTRACT } from '../../shared/resources/release/runtime-cache-contract.v3972_5.js?v=3972_5';
...
export function startLnRankRuntime() {
  ...
  startPromise = (async () => {
    ...
    const workspace = await import('./workspace/selection-workspace-orchestrator.v3972_5.js?v=3972_5');
