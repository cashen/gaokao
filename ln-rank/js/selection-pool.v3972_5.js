...
try {
  await import('./selection-pool-runtime.v3972_5.js?v=3972_5');
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({
      state: 'ready',
      version: 'selection-runtime-v3972_5',
  ...
  console.error('[selection-runtime-v3972_5] initialization failed', error);
}
