const RUNTIME_VERSION = 'resource-execution-v3968_0';
...
try {
  const runtime = await import('./app-runtime.v3968_0.js?v=3968_0');
  ...
  console.error('[ln-rank-runtime-v3968_0] initialization failed', error);
}
