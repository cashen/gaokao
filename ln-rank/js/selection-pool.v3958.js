...
import { requestPathAnalysis } from './feature/selection-pool/path-analysis-api.v3958.js';
import { buildCandidateContext, buildComputedSignature } from './feature/selection-pool/candidate-context.v3958.js';
import { getComputedStats, recomputeSelectionPool, sortComputedByBand, stripComputedForStorage } from './feature/selection-pool/recompute-selection-pool.v3958.js';
import { createSelectionPoolFeishuReport } from './feature/selection-pool/feishu-selection-report-api.v3955.js';

const SCORE_KEY = 'lnRank.selectionPool.candidateScore.v3958';
...
function buildCurrentState({ persistScore = true } = {}) {
  ...
  currentComputedState = { rawItems, items: computedItems, stats, candidateContext, orderSignature, signature, score };
