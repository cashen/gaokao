...
export const HUMAN_REPLACEMENTS=[[/稍高目标/g,'稍高目标'],[/高冲/g,'稍高目标'],[/小冲/g,'稍高目标'],[/前段尝试/g,'稍高目标'],[/前段冲刺区/g,'稍高目标区'],[/主体承接区/g,'主要参考区'],[/主要承接/g,'主要参考'],[/后段补充/g,'低分侧补充'],[/最后兜底/g,'低分侧补充'],[/兜底/g,'低分侧补充'],[/保底深度/g,'低分侧补充是否够厚'],[/浅后段是否够稳/g,'低分侧补充偏浅'],[/后段是否够稳/g,'低分侧补充是否够厚'],[/保底/g,'低分侧补充'],[/冲稳保结构/g,'稍高目标/主要参考/低分侧补充结构'],[/冲稳保/g,'分段结构'],[/自选池/g,'已选专业'],[/加入自选专业/g,'放进报告'],[/已加入自选专业/g,'已放进报告'],[/自选专业/g,'已选专业'],[/报告清单/g,'已选专业'],[/专业集中度/g,'专业方向是否过于集中'],[/地域单点风险/g,'城市过于集中'],[/主体承接/g,'主要参考']];
export const HUMAN_FORBIDDEN_VISIBLE_WORDS=['payload','raw','source','debug','model','JSON','workers-ai','fallback','AI_PATH_MODEL','稳进','必录','保证','一定能上','闭眼报','稳赚','捡漏','NaN','undefined','null','[object Object]','自选池','本机自选','收藏夹','我的方案','我的备忘','草稿箱','报告清单','录取判断','稳进','必录','保底','兜底','匹配度 92%'];
