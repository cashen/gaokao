...
} from '../feature/major-pool/index.v3964_0.js?v=3964_0';
import {
  renderBandLegend,
...
import {
  ...
  renderFeishuReport,
  clearFeishuReport
} from '../feature/feishu/index.v3965_0.js?v=3965_0';
import {
  initSelectionPool,
...
document.body.dataset.scoreState = 'empty';
  document.body.dataset.workspaceOrchestration = 'selection-workspace-orchestration-v3965_0';

function log(...args) {
  if (DEBUG) console.info('[selection-workspace-v3965]', ...args);
}
