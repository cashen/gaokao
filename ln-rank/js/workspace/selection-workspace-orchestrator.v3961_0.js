...
} from '../../../shared/resources/exam/liaoning-physics.js?v=3961_0';
import { toInt } from '../core/number-utils.js?v=3961_0';
...
} from '../feature/score-bands/index.v3961_0.js?v=3961_0';
import {
  initFeishuReport,
  renderFeishuReport,
  clearFeishuReport
} from '../feature/feishu/index.v3956_0.js?v=3961_0';
import {
  initSelectionPool,
  refreshSelectionPool,
  createSelectionPoolAdapter
} from '../feature/selection-pool/index.v3961_0.js?v=3961_0';
import { renderSearchTrendHint } from '../feature/trend/index.js?v=3961_0';
import {
  getQueryButtonLabel,
  getQueryButtonClass,
...
import { getRangePresetLabel } from '../domain/range-policy.js?v=3961_0';
import { getBandFocusLabel } from '../domain/band-policy.js?v=3961_0';
import {
  setRangePreset,
  setBandFocus,
  syncRangeState
} from '../state/range-state.js?v=3961_0';
import { syncControlConsoleState } from '../ui/control-console.js?v=3961_0';
import { normalizeMajorBandsResponse } from '../domain/score-band-contract.js?v=3961_0';
import {
...
import { renderMainFlowStepper } from '../feature/flow-stepper/flow-stepper-render.js?v=3961_0';
import {
...
} from './result-commit.v3961_0.js?v=3961_0';
import {
...
function bind() {
  ...
  const onScoreInput = () => {
    const before = lastNormalizedScore;
    parseScoreFromInput();
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', mountSelectionWorkspace, { once: true });
} else {
