...
document.body.dataset.scoreState = 'empty';
  document.body.dataset.workspaceOrchestration = 'selection-workspace-orchestration-v3967_0';

function log(...args) {
  if (DEBUG) console.info('[selection-workspace-v3967]', ...args);
}
...
export function mountSelectionWorkspace() {
  ...
  globalThis.__GAOKAO_SELECTION_WORKSPACE__ = Object.freeze({
    version: 'selection-workspace-orchestration-v3967_0',
    getState: () => ({
      dirty,
      committedQuery,
      committedSummary,
