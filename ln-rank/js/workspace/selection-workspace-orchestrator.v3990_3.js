...
const VERSION = 'selection-workspace-orchestration-v3990_3';
...
const stableModule = await import('./selection-workspace-orchestrator.v3969_2.js?v=3969_2&r=r044-ln-rank-navigation-focus-query');
