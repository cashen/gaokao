...
import { renderMajorResults } from './feature/major-pool/major-pool-render.v3987.js';
import { buildKeywordQuery } from './feature/major-pool/keyword-parser.v3987.js';
import { mountKeywordPresetPanel } from './feature/major-pool/keyword-chip-render.v3987.js';
import { initFeishuReport, renderFeishuReport, clearFeishuReport } from './feature/feishu/feishu-report-controller.v3982.js';
import { initSelectionPool, refreshSelectionPool, createSelectionPoolAdapter } from './feature/selection-pool/selection-pool-controller.v3982.js';
import { renderSearchTrendHint } from './major-trend-integration.v3912.js';
import { getQueryButtonLabel, getQueryButtonClass } from './action-state-policy.v3912.js';

let hasQueried = false;
let dirty = false;
const selectionPool = createSelectionPoolAdapter();
document.body?.classList?.add('has-floating-pool-entry');
// v3.9.12：公办底线前端菜单只在【本科线 <= 分数 <= 特控线】显示。
