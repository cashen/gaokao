import '../../shared/resources/release/release-presenter.v3964_1.js?v=3964_1';
import '../../shared/ui/shell/family-shell.v3964_1.js?v=3964_1';
import { CURRENT_RELEASE } from '../../shared/resources/release/current-release.js?v=3964_1';
...
try {
  await import('./selection-pool-runtime.v3964_1.js?v=3964_1');
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({ state: 'ready', version: 'selection-runtime-v3964_1' })
  }));
} catch (error) {
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({ state: 'error', version: 'selection-runtime-v3964_1' })
  }));
  console.error('[selection-runtime-v3964_1] initialization failed', error);
}
