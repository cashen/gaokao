import {
  ...
  removePoolItem,
  classifyPoolItem
} from './feature/selection-pool/selection-pool-store.v3944.js';
import { requestPathAnalysis } from './feature/selection-pool/path-analysis-api.v3944.js';
import { createSelectionPoolFeishuReport } from './feature/selection-pool/feishu-selection-report-api.v3944.js';

const SCORE_KEY = 'lnRank.selectionPool.candidateScore.v3944';
const LEGACY_SCORE_KEYS = ['lnRank.selectionPool.candidateScore.v3943', 'lnRank.selectionPool.candidateScore.v3942', 'lnRank.selectionPool.candidateScore.v3941', 'lnRank.selectionPool.candidateScore.v3940'];
