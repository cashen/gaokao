import '../../shared/resources/release/release-presenter.v3990_0.js?v=3990_0';
import './domain/family-plan-copy-adapter.v3970_0.js?v=3970_0';
import '../../shared/ui/shell/family-shell.v3990_0.js?v=3990_0';
import { CURRENT_RELEASE } from '../../shared/resources/release/current-release.js?v=3990_0';
import { SITE_RUNTIME_CONTRACT } from '../../shared/resources/release/site-runtime-contract.v3990_0.js?v=3990_0';
...
try {
  await import('./selection-pool-runtime.v3990_0.js?v=3990_0');
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({
      state: 'ready',
      version: 'selection-runtime-v3990_0',
  ...
  console.error('[selection-runtime-v3990_0] initialization failed', error);
}
