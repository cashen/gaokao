import {
  ...
  savePoolItems
} from './feature/selection-pool/index.js?v=3920_2';
import { requestPathAnalysis } from './feature/selection-pool/index.js?v=3920_2';
import { buildCandidateContext, buildComputedSignature } from './feature/selection-pool/index.js?v=3920_2';
import { getComputedStats, recomputeSelectionPool, sortComputedByBand, stripComputedForStorage } from './feature/selection-pool/index.js?v=3920_2';
import { renderHealthLights } from './feature/selection-pool/index.js?v=3920_2';
import { createSelectionPoolFeishuReport } from './feature/selection-pool/index.js?v=3920_2';
import { buildTrendSummaryForSelection, renderSelectionTrendBox } from './feature/trend/index.js?v=3920_2';
import { renderParentCoach } from './feature/decision-coach/index.js?v=3920_2';
import { getCampusForRecord } from './feature/campus/index.js?v=3920_2';
import { buildReviewChecklist, renderReviewChecklist } from './feature/review-checklist/index.js?v=3920_2';
import { normalizeSelectedMajors } from './domain/selection-contract.js?v=3920_2';
import { buildReportPayload } from './domain/report-payload-contract.js?v=3920_2';
import { toHumanCopy } from './domain/human-copy-dictionary.js?v=3920_2';
...
function createReportContext(state = getState()) {
  return { candidateScore: state.score || null, selectedCount: state.items?.length || 0, bottomLineMode: state.bottomLineMode || 'all', rangePreset: 'standard', activeBand: null, generatedAt: new Date().toISOString(), version: 'v3.9.20.2' };
}
