...
import { CURRENT_RELEASE } from '../../shared/resources/release/current-release.js?v=3990_3&r=r044-ln-rank-navigation-focus-query';
...
export function startLnRankRuntime() {
  ...
  startPromise = (async () => {
    ...
    const workspace = await import('./workspace/selection-workspace-orchestrator.v3990_3.js?v=3990_3&r=r044-ln-rank-navigation-focus-query');
    await workspace.selectionWorkspaceReady;
    const schoolMode = await import('./feature/school-majors/school-all-mode.v3969_2.js?v=3969_2&r=r044-ln-rank-navigation-focus-query');
    await schoolMode.schoolAllModeReady;
    const majorMode = await import('./feature/major-all/major-all-mode.v001.js?v=3990_3&context=major-filter-context-v004&r=r044-ln-rank-navigation-focus-query');
