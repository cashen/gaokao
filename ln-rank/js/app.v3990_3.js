...
import { mountMajorPathHandoff } from './workspace/major-path-handoff.v003.js?v=003_0&r=r043-ln-rank-semantic-navigation';
...
try {
  const runtime = await import('./app-runtime.v3990_3.js?v=3990_3-nav003&r=r043-ln-rank-semantic-navigation');
