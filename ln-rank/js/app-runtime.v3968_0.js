...
import { CURRENT_RELEASE } from '../../shared/resources/release/current-release.js?v=3968_0';
import { LN_RANK_RUNTIME_CACHE_CONTRACT } from '../../shared/resources/release/runtime-cache-contract.v3968_0.js?v=3968_0';
import { ALGORITHM_CONTRACT } from '../../shared/algorithms/algorithm-registry.js?v=3968_0';
...
export function startLnRankRuntime() {
  ...
  startPromise = (async () => {
    const workspace = await import('./workspace/selection-workspace-orchestrator.v3967_0.js?v=3967_0');
    await workspace.selectionWorkspaceReady;
    const schoolMode = await import('./feature/school-majors/school-all-mode.v3967_0.js?v=3967_0');
