import { CURRENT_RELEASE } from '../../shared/resources/release/current-release.js?v=3959_0';
...
async function main() {
  ...
  try {
    ...
    $('versionBox').textContent = `${active.version} / ${active.assetVersion} / ${release.releaseName || release.release || ''} / ${CURRENT_RELEASE.resourceOwnershipVersion} / ${CURRENT_RELEASE.uiOrchestrationVersion}`;
  } catch (error) {
