...
import { renderMajorResults } from './feature/major-pool/major-pool-render.v3942.js';
import { initFeishuReport, renderFeishuReport, clearFeishuReport } from './feature/feishu/feishu-report-controller.v3916.js';
import { initSelectionPool, refreshSelectionPool, createSelectionPoolAdapter } from './feature/selection-pool/selection-pool-controller.v3942.js';
...
function parseScoreFromInput() {
  ...
  try { if (state.candidateScore) localStorage.setItem('lnRank.selectionPool.candidateScore.v3942', String(state.candidateScore)); } catch {}
