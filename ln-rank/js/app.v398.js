...
import { fetchMajorBands } from './feature/major-pool/major-bands-api.v398.js';
import { renderBandTabs } from './feature/score-bands/score-bands-render.v398.js';
import { renderMajorResults } from './feature/major-pool/major-pool-render.v398.js';
...
async function loadData(){
  ...
  try {
    ...
    setReadyStatus('ready', '读取完成');
  }
  catch(e){ state.bands.error = e.message || String(e); state.bands.data = null; setReadyStatus('error', '读取异常'); }
