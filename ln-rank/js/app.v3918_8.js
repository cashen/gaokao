...
import { getScoreGuard } from './core/score-guard.js';
import { REGION_OPTIONS } from './config/region-options.js';
import { fetchMajorBands } from './feature/major-pool/index.js?v=3918_8';
import { renderBandLegend, renderResultBandSwitcher } from './feature/score-bands/index.js?v=3918_8';
import { renderMajorResults } from './feature/major-pool/index.js?v=3918_8';
import { buildKeywordQuery } from './feature/major-pool/index.js?v=3918_8';
import { mountKeywordPresetPanel } from './feature/major-pool/index.js?v=3918_8';
import { initFeishuReport, renderFeishuReport, clearFeishuReport } from './feature/feishu/index.js';
import { initSelectionPool, refreshSelectionPool, createSelectionPoolAdapter } from './feature/selection-pool/index.js';
import { renderSearchTrendHint } from './feature/trend/index.js';
import { getQueryButtonLabel, getQueryButtonClass, initBottomLineSheet, bottomLineLabel as uiBottomLineLabel, initRankBandLegend } from './feature/ui/index.js';
import { getRangePresetLabel } from './domain/range-policy.js';
import { getBandFocusLabel } from './domain/band-policy.js';
import { setRangePreset, setBandFocus, syncRangeState } from './state/range-state.js';
import { syncControlConsoleState } from './ui/control-console.js';
import { normalizeMajorBandsResponse } from './domain/major-bands-response-normalizer.js?v=3918_8';
