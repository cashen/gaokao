const RUNTIME_VERSION = 'resource-execution-v3970_0';
...
try {
  const runtime = await import('./app-runtime.v3970_0.js?v=3970_0');
  ...
  console.error('[ln-rank-runtime-v3970_0] initialization failed', error);
}
