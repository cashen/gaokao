...
import '../../shared/ui/shell/family-shell.v3990_2.js?v=3990_2';
...
try {
  await import('./selection-pool-runtime.v3990_2.js?v=3990_2');
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({
      state: 'ready',
      version: 'selection-runtime-v3990_2',
  ...
  console.error('[selection-runtime-v3990_2] initialization failed', error);
}
