...
} from '../../shared/resources/resource-registry.js?v=3990_0';
import {
...
async function runSelfCheck() {
  ...
  try {
    const identities = [
      [CURRENT_RELEASE.display, 'v3.9.90.0', '公开版本'],
      [CURRENT_RELEASE.siteRuntimeGeneration, 'v3990_0', '运行时代际'],
      [CURRENT_RELEASE.asset, '3990_0', '查询版本'],
