...
} from '../../shared/resources/resource-registry.js?v=3990_1';
import {
...
} from '../../shared/ui/ui-resource-registry.v3990_1.js?v=3990_1';
...
} from './feature/major-pool/pagination-snapshot-guard.v3990_1.js?v=3990_1';
...
async function runSelfCheck() {
  ...
  try {
    const identities = [
      [CURRENT_RELEASE.display, 'v3.9.90.1', '公开版本'],
      [CURRENT_RELEASE.siteRuntimeGeneration, 'v3990_1', '运行时代际'],
      [CURRENT_RELEASE.asset, '3990_1', '查询版本'],
      ...
      [CURRENT_RELEASE.interactionVersion, 'interaction-transaction-v3990_1', '交互版本'],
      [CURRENT_RELEASE.nativeChooserActivationVersion, 'native-chooser-activation-integrity-v3990_1', '原生选择器激活版本'],
      [MAJOR_BANDS_PAGINATION_SNAPSHOT_GUARD_VERSION, 'major-bands-pagination-snapshot-guard-v3990_1', '分页快照守卫版本']
    ];
