import {
  ...
  savePoolItems
} from './feature/selection-pool/index.js?v=3933_9';
import { requestPathAnalysis } from './feature/selection-pool/index.js?v=3933_9';
import { buildCandidateContext, buildComputedSignature } from './feature/selection-pool/index.js?v=3933_9';
import { getComputedStats, recomputeSelectionPool, sortComputedByBand, stripComputedForStorage } from './feature/selection-pool/index.js?v=3933_9';
import { renderHealthLights } from './feature/selection-pool/index.js?v=3933_9';
import { createSelectionPoolFeishuReport } from './feature/selection-pool/index.js?v=3933_9';
import { buildTrendSummaryForSelection, renderSelectionTrendBox } from './feature/trend/index.js?v=3933_9';
import { compactHistoryScoreText, historyScoreText } from './feature/major-pool/history-score-render.js?v=3933_9';
import { renderParentCoach } from './feature/decision-coach/index.js?v=3933_9';
import { getCampusForRecord } from './feature/campus/index.js?v=3933_9';
import { buildReviewChecklist, renderReviewChecklist } from './feature/review-checklist/index.js?v=3933_9';
import { normalizeSelectedMajors } from './domain/selection-contract.js?v=3933_9';
import { buildReportPayload } from './domain/report-payload-contract.js?v=3933_9';
import { toHumanCopy, REPORT_COPY } from './domain/human-copy-dictionary.js?v=3933_9';
import { renderDirectionExplorerReportHtml, buildDirectionExplorerReportText, getDirectionExplorerReportContext } from './feature/direction-explorer/direction-explorer-report.js?v=3933_9';
import { buildKnowledgeReviewForRecord, buildKnowledgePortfolioSummary, buildSchoolIndustryTags, KNOWLEDGE_DATA_BOUNDARY, safeGetLocalContextPresentation, buildLocalContextSummary } from './knowledge/index.js?v=3933_9';

const SCORE_KEY = 'lnRank.selectionPool.candidateScore';
const SCORE_VERSION_KEY = 'lnRank.selectionPool.candidateScore.v3933_9';
...
function createReportContext(state = getState()) {
  return { candidateScore: state.score || null, selectedCount: state.items?.length || 0, bottomLineMode: state.bottomLineMode || 'all', rangePreset: 'standard', activeBand: null, directionExplorer: getDirectionExplorerReportContext(), generatedAt: new Date().toISOString(), version: 'v3.9.33.9' };
}
