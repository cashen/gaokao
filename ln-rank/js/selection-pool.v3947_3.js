import {
  ...
  savePoolItems
} from './feature/selection-pool/index.js?v=3947_2';
import { requestPathAnalysis } from './feature/selection-pool/index.js?v=3947_2';
import { buildCandidateContext, buildComputedSignature } from './feature/selection-pool/index.js?v=3947_2';
import { getComputedStats, recomputeSelectionPool, sortComputedByBand, stripComputedForStorage } from './feature/selection-pool/index.js?v=3947_2';
import { renderHealthLights } from './feature/selection-pool/index.js?v=3947_2';
import { createSelectionPoolFeishuReport } from './feature/selection-pool/index.js?v=3947_2';
import { buildTrendSummaryForSelection, renderSelectionTrendBox } from './feature/trend/index.js?v=3947_2';
import { compactHistoryScoreText, historyScoreText } from './feature/major-pool/history-score-render.js?v=3947_2';
import { renderParentCoach } from './feature/decision-coach/index.js?v=3947_2';
import { getCampusForRecord } from './feature/campus/index.js?v=3947_2';
import { buildReviewChecklist, renderReviewChecklist } from './feature/review-checklist/index.js?v=3947_2';
import { normalizeSelectedMajors } from './domain/selection-contract.js?v=3947_2';
import { buildReportPayload } from './domain/report-payload-contract.js?v=3947_2';
import { toHumanCopy, REPORT_COPY } from './domain/human-copy-dictionary.js?v=3947_2';
import { renderDirectionExplorerReportHtml, buildDirectionExplorerReportText, getDirectionExplorerReportContext } from './feature/direction-explorer/direction-explorer-report.js?v=3947_2';
import { buildKnowledgeReviewForRecord, buildKnowledgePortfolioSummary, buildSchoolIndustryTags, KNOWLEDGE_DATA_BOUNDARY, safeGetLocalContextPresentation, buildLocalContextSummary } from './knowledge/index.js?v=3947_2';
import { resolveLocalStrengthMark, buildLocalStrengthSummary } from './feature/major-pool/local-strength-view.js?v=3947_2';
import { resolveMajorUnderstanding, majorUnderstandingReportLines } from './knowledge/major-understanding-resolver.js?v=3947_2';
import { resolvePlanFlowStep, markFlowAction, clearFlowAction } from './domain/flow-step-contract.js?v=3947_2';
import { buildSelectionSignature, markReportGenerating, markReportFresh, markReportFailed, expireReport, clearReportFreshness, readReportFreshness } from './domain/report-freshness-contract.js?v=3947_2';
import { buildSelectionConsistencyNotes } from './domain/selection-consistency-contract.js?v=3947_2';
import { renderPlanFlowStepper } from './feature/flow-stepper/flow-stepper-render.js?v=3947_2';

const SCORE_KEY = 'lnRank.selectionPool.candidateScore';
const SCORE_VERSION_KEY = 'lnRank.selectionPool.candidateScore.v3947_3';
...
function createReportContext(state = getState()) {
  return { candidateScore: state.score || null, selectedCount: state.items?.length || 0, bottomLineMode: state.bottomLineMode || 'all', rangePreset: 'standard', activeBand: null, directionExplorer: getDirectionExplorerReportContext(), generatedAt: new Date().toISOString(), version: 'v3.9.47.3' };
}
