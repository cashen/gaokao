...
function inputState() { return Object.freeze({
  version: 'major-filter-context-v003',
...
export function mountMajorAllMode(){if(mounted)return globalThis.__GAOKAO_MAJOR_ALL_MODE__;mounted=true;bind();syncMode();const api=Object.freeze({version:MAJOR_ALL_MODE_VERSION,inputVersion:'major-filter-context-v003',submit:()=>load(false),isBlocking:()=>majorInputBlocking(),getInputState:()=>inputState(),getState:()=>({...view,input:inputState()})});globalThis.__GAOKAO_MAJOR_ALL_MODE__=api;return api;}
