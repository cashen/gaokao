...
import { canGenerateFeishuReport } from "../report/report-payload-builder.v3976.js";
...
export function renderFeishuReportView(reportState, appState, handlers) {
  ...
  root.innerHTML = `
    <div class="feishu-box ${disabled ? "is-disabled" : ""}">
      ...
      <span class="feishu-note">${disabled ? availability.reason : "生成当前区间前 20 条专业结果，并返回飞书文档链接。筛选条件会一并写入报告。"}</span>
    </div>
  `;
