import { MAJOR_TREND_DATA } from './data.v3967_0.js?v=3967_0';
import { resolveTrendInterpretation } from '../../../../shared/algorithms/trend/trend-interpretation.v3967_0.js?v=3967_0';
...
export function trendTone(direction = {}) {
  const interpretation = resolveTrendInterpretation({
    ...direction,
    medianRelativePctPoint26vs25: direction.medianRelativePctPoint26vs25 ?? direction.relativePctPoint26vs25
  }, { neutralThresholdPctPoint: direction.neutralThresholdPctPoint ?? direction.threshold ?? 1 });
  return interpretation.key === 'stable' ? 'neutral' : interpretation.key;
}
...
export function trendLabel(direction = {}) {
  ...
  return interpretation.key === 'harder' ? '相比多数专业更难报'
    : interpretation.key === 'easier' ? '相比多数专业更容易报'
      : '和多数专业变化接近';
}
