const STORAGE_KEY = 'lnRank.selectionPool.physics2025.v3948';
const LEGACY_KEYS = ['lnRank.selectionPool.physics2025.v3947', 'lnRank.selectionPool.physics2025.v3946', 'lnRank.selectionPool.physics2025.v3945', 'lnRank.selectionPool.physics2025.v3944', 'lnRank.selectionPool.physics2025.v3943', 'lnRank.selectionPool.physics2025.v3942', 'lnRank.selectionPool.physics2025.v3941', 'lnRank.selectionPool.physics2025.v3940', 'lnRank.selectionPool.physics2025', 'lnRankSelectionPool.v3940'];
const MAX_ITEMS = 112;
...
export function addPoolItem(record) {
  ...
  return { ok: true, message: '已加入自选池，点右侧进入完整整理。', items: next };
}
