import {
  ...
  movePoolItem,
  classifyPoolItem
} from './selection-pool-store.v3943.js';
import { requestPathAnalysis } from './path-analysis-api.v3943.js';
import { createSelectionPoolFeishuReport } from './feishu-selection-report-api.v3943.js';
...
function getCandidateScore() {
  return latestState?.candidateScore || Number(localStorage.getItem('lnRank.selectionPool.candidateScore.v3943')) || Number(localStorage.getItem('lnRank.selectionPool.candidateScore.v3942')) || Number(localStorage.getItem('lnRank.selectionPool.candidateScore.v3941')) || Number(localStorage.getItem('lnRank.selectionPool.candidateScore.v3940')) || null;
}
