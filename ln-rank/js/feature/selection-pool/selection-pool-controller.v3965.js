...
function getInlineMount() {
  return document.getElementById('selectionPoolInlineMount');
}
...
function renderPoolEntry({ items, isBumped }) {
  return `<a id="selectionPoolFab" class="selection-pool-fab direct-pool-entry ${isBumped ? 'is-bumped' : ''}" href="${getPoolHref()}" aria-label="进入自选池完整整理页">
