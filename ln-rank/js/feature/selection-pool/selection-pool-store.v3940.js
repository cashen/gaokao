const STORAGE_KEY = 'lnRank.selectionPool.physics2025.v3940';
const LEGACY_KEYS = ['lnRank.selectionPool.physics2025', 'lnRankSelectionPool.v3940'];
const MAX_ITEMS = 112;
...
export function addPoolItem(record) {
  ...
  return { ok: true, message: '已加入自选池。', items: next };
}
