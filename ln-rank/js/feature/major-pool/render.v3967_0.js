...
import { renderHistoryScore, historyYearText } from './history-score-render.v3967_0.js?v=3967_0';
import { mountDiagnoseButtons } from '../diagnose/controller.v3967_0.js?v=3967_0';
...
function compareYearText(record = {}) {
  return {
    year2026: historyYearText(record, 2026),
    year2025: historyYearText(record, 2025),
    year2024: historyYearText(record, 2024)
  };
}
...
function card(record, index = 0, selectionPool = null, activeBand = 'near', viewMode = 'all', compareInfo = null) {
  ...
  return `<article data-ui-component="major-results" class="major-card ln-major-card status-${statusKey} ${bandClass}${strengthClass}">
