...
import { mountDiagnoseButtons } from '../diagnose/diagnose-controller.v3931.js';
...
function card(record, index = 0) {
  ...
  return `<article class="major-card status-${statusKey}">
    ...
    <div class="diagnose-actions"><button class="diagnose-button" type="button" data-diagnose-index="${index}">AI诊断</button></div>
  </article>`;
}
