import { MAJOR_KEYWORD_ALIASES, BROAD_MAJOR_KEYWORDS } from './major-keyword-policy.js?v=3921_6';
import { PROJECT_KEYWORD_ALIASES } from './project-keyword-policy.js?v=3921_6';
import { INDUSTRY_KEYWORD_ALIASES } from './industry-keyword-policy.js?v=3921_6';
import { classifyKeywordTokens } from './keyword-token-classifier.js?v=3921_6';
