/* v3.9.33.3 院校专业背景展示调度器
 * 统一整合：本校方向、本校相关、方向提醒。
 * 卡片/自选只给短提示；生成前确认/报告才给完整解释。
 */
import { matchLiaoningLocalStrongChain } from './liaoning-local-strong-chain.js?v=3933_3';
import { matchLiaoningMajorTrajectory } from './liaoning-major-trajectory-chain.js?v=3933_3';
