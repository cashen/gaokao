/* v3.9.33.9 省内专业背景分层提示合同
 * 目标：不是所有省内院校都显示背景提示，也不是有省内背景却完全空白。
 * 层级：不显示 / 方向提醒 / 本校相关 / 本校方向。
 */
import { matchLiaoningLocalStrongChain } from './liaoning-local-strong-chain.js?v=3933_9';
import { matchLiaoningMajorTrajectory } from './liaoning-major-trajectory-chain.js?v=3933_9';
import { normalizeMajorName, normalizeSchoolName, candidateMajorNames } from './major-match-contract.js?v=3933_9';
import { LIAONING_SCHOOL_MAINLINE_EVIDENCE } from '../../kb/local-mainline/school-mainline-evidence.generated.js?v=3933_9';
import { LOCAL_MAINLINE_MAJOR_ALIAS_BRIDGE } from '../../kb/local-mainline/local-mainline-major-alias-bridge.generated.js?v=3933_9';
