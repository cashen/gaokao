import { MAJOR_TREND_DATA, trendTone } from './feature/trend/index.js?v=3921_4';
...
export function mountMajorTrendPage() {
  ...
  function render() {
    ...
    root.innerHTML = `
      ...
      <section class="data-note">${escapeHtml(MAJOR_TREND_DATA.disclaimer)}<br>版本：v3.9.21.4｜数据口径：辽宁 2025 物理类｜变化口径：2024/2025 同校同专业普通项目</section>`;
