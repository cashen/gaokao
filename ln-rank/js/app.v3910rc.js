...
import { renderSearchTrendHint } from './major-trend-integration.v3987.js';
...
const BOTTOMLINE_STORAGE_KEY = 'lnRank.bottomLineMode.v3910rc';
...
function setActionButton() {
  ...
  if (guide) guide.textContent = '可以继续调整地域、学校或专业方向或项目关键词后更新结果。';
}
