import {
  ...
  savePoolItems
} from './feature/selection-pool/index.v3963_1.js?v=3963_1';
import { requestPathAnalysis } from './feature/selection-pool/index.v3963_1.js?v=3963_1';
import { buildCandidateContext, buildComputedSignature } from './feature/selection-pool/index.v3963_1.js?v=3963_1';
import { getComputedStats, recomputeSelectionPool, sortComputedByBand, stripComputedForStorage } from './feature/selection-pool/index.v3963_1.js?v=3963_1';
import { renderHealthLights } from './feature/selection-pool/index.v3963_1.js?v=3963_1';
import { createSelectionPoolFeishuReport } from './feature/selection-pool/index.v3963_1.js?v=3963_1';
...
import { toHumanCopy, REPORT_COPY } from './domain/human-copy-dictionary.js?v=3951_0';
...
import { FEISHU_REPORT_CONTRACT, FEISHU_YEAR_CALIBER } from '../../shared/resources/reports/feishu-report-contract.v3963_1.js?v=3963_1';
