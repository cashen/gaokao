import { state } from './state/app-state.js?v=3933_11';
import { toInt } from './core/number-utils.js?v=3933_11';
import { getScoreGuard } from './core/score-guard.js?v=3933_11';
import { REGION_OPTIONS } from './config/region-options.js?v=3933_11';
import { fetchMajorBands } from './feature/major-pool/index.js?v=3933_11';
import { renderBandLegend, renderResultBandSwitcher } from './feature/score-bands/index.js?v=3933_11';
import { renderMajorResults } from './feature/major-pool/index.js?v=3933_11';
import { buildKeywordQuery } from './feature/major-pool/index.js?v=3933_11';
import { mountKeywordPresetPanel } from './feature/major-pool/index.js?v=3933_11';
import { initFeishuReport, renderFeishuReport, clearFeishuReport } from './feature/feishu/index.js?v=3933_11';
import { initSelectionPool, refreshSelectionPool, createSelectionPoolAdapter } from './feature/selection-pool/index.js?v=3933_11';
import { renderSearchTrendHint } from './feature/trend/index.js?v=3933_11';
import { getQueryButtonLabel, getQueryButtonClass, initBottomLineSheet, bottomLineLabel as uiBottomLineLabel, initRankBandLegend } from './feature/ui/index.js?v=3933_11';
import { getRangePresetLabel } from './domain/range-policy.js?v=3933_11';
import { getBandFocusLabel } from './domain/band-policy.js?v=3933_11';
import { setRangePreset, setBandFocus, syncRangeState } from './state/range-state.js?v=3933_11';
import { syncControlConsoleState } from './ui/control-console.js?v=3933_11';
import { normalizeMajorBandsResponse } from './domain/score-band-contract.js?v=3933_11';
import { normalizeSpecialProjectMode, SPECIAL_PROJECT_STORAGE_KEY, SPECIAL_PROJECT_HIDE_MODE, SPECIAL_PROJECT_SHOW_MODE, specialProjectStatusCopy, specialProjectToggleLabel, specialProjectHelpCopy } from './domain/special-project-policy.js?v=3933_11';
import { initDirectionExplorer } from './feature/direction-explorer/direction-explorer-render.js?v=3933_11';
import { formatApiErrorForHuman, formatApiErrorForEngineer, isApiClientError } from './shared/api-client.js?v=3933_11';
...
function parseScoreFromInput() {
  ...
  try {
    if (state.candidateScore) {
      ...
      localStorage.setItem('lnRank.selectionPool.candidateScore.v3933_11', String(state.candidateScore));
    } else {
