import {
  ...
  savePoolItems
} from './feature/selection-pool/index.js?v=3922_1';
import { requestPathAnalysis } from './feature/selection-pool/index.js?v=3922_1';
import { buildCandidateContext, buildComputedSignature } from './feature/selection-pool/index.js?v=3922_1';
import { getComputedStats, recomputeSelectionPool, sortComputedByBand, stripComputedForStorage } from './feature/selection-pool/index.js?v=3922_1';
import { renderHealthLights } from './feature/selection-pool/index.js?v=3922_1';
import { createSelectionPoolFeishuReport } from './feature/selection-pool/index.js?v=3922_1';
import { buildTrendSummaryForSelection, renderSelectionTrendBox } from './feature/trend/index.js?v=3922_1';
import { renderParentCoach } from './feature/decision-coach/index.js?v=3922_1';
import { getCampusForRecord } from './feature/campus/index.js?v=3922_1';
import { buildReviewChecklist, renderReviewChecklist } from './feature/review-checklist/index.js?v=3922_1';
import { normalizeSelectedMajors } from './domain/selection-contract.js?v=3922_1';
import { buildReportPayload } from './domain/report-payload-contract.js?v=3922_1';
import { toHumanCopy, REPORT_COPY } from './domain/human-copy-dictionary.js?v=3922_1';
...
function createReportContext(state = getState()) {
  return { candidateScore: state.score || null, selectedCount: state.items?.length || 0, bottomLineMode: state.bottomLineMode || 'all', rangePreset: 'standard', activeBand: null, generatedAt: new Date().toISOString(), version: 'v3.9.22' };
}
