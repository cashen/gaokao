...
import { CURRENT_RELEASE } from '../../shared/resources/release/current-release.js?v=3990_3';
...
try {
  await import('./selection-pool-runtime.v3990_3.js?v=3990_3');
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({
      state: 'ready',
      version: 'selection-runtime-v3990_3',
  ...
  console.error('[selection-runtime-v3990_3] initialization failed', error);
}
