const RUNTIME_VERSION = 'resource-execution-v3972_4';
...
try {
  const runtime = await import('./app-runtime.v3972_4.js?v=3972_4');
  ...
  console.error('[ln-rank-runtime-v3972_4] initialization failed', error);
}
