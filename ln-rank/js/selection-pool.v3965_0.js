...
try {
  await import('./selection-pool-runtime.v3965_0.js?v=3965_0');
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({ state: 'ready', version: 'selection-runtime-v3965_0' })
  }));
} catch (error) {
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({ state: 'error', version: 'selection-runtime-v3965_0' })
  }));
  console.error('[selection-runtime-v3965_0] initialization failed', error);
}
