...
try {
  await import('./selection-pool-runtime.v3972_6.js?v=3972_6');
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({
      state: 'ready',
      version: 'selection-runtime-v3972_6',
  ...
  console.error('[selection-runtime-v3972_6] initialization failed', error);
}
