import '../../shared/resources/release/release-presenter.v3970_0.js?v=3970_0';
import './workspace/viewport-orchestrator.v3961_0.js?v=3961_0';
import './domain/family-plan-copy-adapter.v3970_0.js?v=3970_0';
import '../../shared/ui/shell/family-shell.v3970_0.js?v=3970_0';
import {
  LIAONING_PHYSICS_EXAM_CONFIG,
  isPublicBottomLineVisible
} from '../../shared/resources/exam/liaoning-physics.js?v=3967_0';
import { CURRENT_RELEASE } from '../../shared/resources/release/current-release.js?v=3970_0';
import { LN_RANK_RUNTIME_CACHE_CONTRACT } from '../../shared/resources/release/runtime-cache-contract.v3970_0.js?v=3970_0';
...
globalThis.__GAOKAO_SHARED_RESOURCES__ = Object.freeze({
  ...
  resourceExecution: CURRENT_RELEASE.resourceExecutionVersion,
...
export function startLnRankRuntime() {
  ...
  startPromise = (async () => {
    ...
    const workspace = await import('./workspace/selection-workspace-orchestrator.v3972_4.js?v=3972_4');
    ...
    return Object.freeze({
      ...
      baseRuntimeCache: LN_RANK_RUNTIME_CACHE_CONTRACT.version,
