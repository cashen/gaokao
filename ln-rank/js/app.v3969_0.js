const RUNTIME_VERSION = 'resource-execution-v3969_0';
...
try {
  const runtime = await import('./app-runtime.v3969_0.js?v=3969_0');
  ...
  console.error('[ln-rank-runtime-v3969_0] initialization failed', error);
}
