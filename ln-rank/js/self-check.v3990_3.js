...
} from '../../shared/resources/resource-registry.js?v=3990_3';
import {
...
} from '../../shared/ui/ui-resource-registry.v3990_3.js?v=3990_3';
...
async function runSelfCheck() {
  ...
  try {
    const identities = [
      [CURRENT_RELEASE.display, 'v3.9.90.3', '公开版本'],
      [CURRENT_RELEASE.siteRuntimeGeneration, 'v3990_3', '运行时代际'],
      [CURRENT_RELEASE.asset, '3990_3', '查询版本'],
      ...
      [CURRENT_RELEASE.interactionVersion, 'interaction-transaction-v3990_3', '交互版本'],
      [CURRENT_RELEASE.nativeChooserActivationVersion, 'native-chooser-activation-integrity-v3990_3', '原生选择器激活版本'],
      [MAJOR_BANDS_PAGINATION_SNAPSHOT_GUARD_VERSION, 'major-bands-pagination-snapshot-guard-v3990_3', '分页快照守卫版本']
    ];
