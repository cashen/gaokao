...
try {
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({ state: 'ready', version: 'selection-runtime-v3970_0' })
  }));
} catch (error) {
  ...
  document.dispatchEvent(new CustomEvent('gaokao:runtime-state', {
    detail: Object.freeze({ state: 'error', version: 'selection-runtime-v3970_0' })
  }));
  console.error('[selection-runtime-v3970_0] initialization failed', error);
}
