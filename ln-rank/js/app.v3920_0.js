import { state } from './state/app-state.js?v=3920_0';
import { toInt } from './core/number-utils.js?v=3920_0';
import { getScoreGuard } from './core/score-guard.js?v=3920_0';
import { REGION_OPTIONS } from './config/region-options.js?v=3920_0';
import { fetchMajorBands } from './feature/major-pool/index.js?v=3920_0';
import { renderBandLegend, renderResultBandSwitcher } from './feature/score-bands/index.js?v=3920_0';
import { renderMajorResults } from './feature/major-pool/index.js?v=3920_0';
import { buildKeywordQuery } from './feature/major-pool/index.js?v=3920_0';
import { mountKeywordPresetPanel } from './feature/major-pool/index.js?v=3920_0';
import { initFeishuReport, renderFeishuReport, clearFeishuReport } from './feature/feishu/index.js?v=3920_0';
import { initSelectionPool, refreshSelectionPool, createSelectionPoolAdapter } from './feature/selection-pool/index.js?v=3920_0';
import { renderSearchTrendHint } from './feature/trend/index.js?v=3920_0';
import { getQueryButtonLabel, getQueryButtonClass, initBottomLineSheet, bottomLineLabel as uiBottomLineLabel, initRankBandLegend } from './feature/ui/index.js?v=3920_0';
...
import { setRangePreset, setBandFocus, syncRangeState } from './state/range-state.js?v=3920_0';
import { syncControlConsoleState } from './ui/control-console.js?v=3920_0';
import { normalizeMajorBandsResponse } from './domain/score-band-contract.js?v=3920_0';
