const RUNTIME_VERSION = 'resource-execution-v3967_0';
...
try {
  const runtime = await import('./app-runtime.v3967_0.js?v=3967_0');
  ...
  console.error('[ln-rank-runtime-v3967_0] initialization failed', error);
}
