...
assert.match(runtime,/const RELEASE='v016\.62-r152'/);
...
assert.equal(release.version,'simulation-workspace-v016.62');
assert.equal(release.revision,'r152-family-note-unified-editor');
assert.equal(release.runtime,'/ln-rank/js/simulation-runtime.js');
assert.equal(release.runtimeRevision,'v016.62-r152');
...
console.log('simulation unified architecture contract r152: PASS');
